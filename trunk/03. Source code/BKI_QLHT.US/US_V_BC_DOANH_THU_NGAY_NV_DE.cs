///************************************************
/// Generated by: TuNA
/// Date: 23-05-2014 09:51:18
/// Goal: Create User Service Class for V_BC_DOANH_THU_NGAY_NV_DE
///************************************************
/// <summary>
/// Create User Service Class for V_BC_DOANH_THU_NGAY_NV_DE
/// </summary>
...
public class US_V_BC_DOANH_THU_NGAY_NV_DE : US_Object
{
	private const string c_TableName = "V_BC_DOANH_THU_NGAY_NV_DE";
...
#region "Init Functions"
    public void FillDatasetSearch(BKI_QLHT.DS.V_BC_DOANH_THU_NGAY_NV_DE op_ds_bc_da, string i_str_tu_khoa, DateTime i_dat_ngay_bd, DateTime i_dat_ngay_kt)
    {
        CStoredProc v_sp = new CStoredProc("pr_V_BC_DOANH_THU_NGAY_NV_DE_search");
	...
	public US_V_BC_DOANH_THU_NGAY_NV_DE() 
	{
        pm_objDS = new BKI_QLHT.DS.V_BC_DOANH_THU_NGAY_NV_DE();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_BC_DOANH_THU_NGAY_NV_DE(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_BC_DOANH_THU_NGAY_NV_DE(decimal i_dbID) 
	{
        pm_objDS = new BKI_QLHT.DS.V_BC_DOANH_THU_NGAY_NV_DE();
		pm_strTableName = c_TableName;
