///************************************************
/// Generated by: DungNT
/// Date: 22/05/2014 04:02:02
/// Goal: Create User Service Class for V_DM_BENH_VIEN
///************************************************
/// <summary>
/// Create User Service Class for V_DM_BENH_VIEN
/// </summary>
...
public class US_V_DM_BENH_VIEN : US_Object
{
	private const string c_TableName = "V_DM_BENH_VIEN";
...
#region "Init Functions"
	public US_V_DM_BENH_VIEN() 
	{
		pm_objDS = new DS_V_DM_BENH_VIEN();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_DM_BENH_VIEN(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_DM_BENH_VIEN(decimal i_dbID) 
	{
		pm_objDS = new DS_V_DM_BENH_VIEN();
		pm_strTableName = c_TableName;
    ...
    public void FillDataseSearch(DS_V_DM_BENH_VIEN ip_ds, string ip_str_tu_khoa)
    {
        CStoredProc v_stored_proc = new CStoredProc("pr_V_DM_BENH_VIEN_Search");
