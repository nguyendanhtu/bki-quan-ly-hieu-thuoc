///************************************************
/// Generated by: TuNA
/// Date: 30-04-2014 11:53:03
/// Goal: Create User Service Class for V_DM_NCC
///************************************************
/// <summary>
/// Create User Service Class for V_DM_NCC
/// </summary>
...
{
	private const string c_TableName = "V_DM_NCC";
...
#region "Init Functions"
	public US_V_DM_NCC() 
	{
		pm_objDS = new DS_V_DM_NCC();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_DM_NCC(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}
    
	public US_V_DM_NCC(decimal i_dbID) 
	{
		pm_objDS = new DS_V_DM_NCC();
		pm_strTableName = c_TableName;
    ...
    public void FillDatasetSearch(DS_V_DM_NCC op_ds, string ip_str_ma_ncc)
    {
        CStoredProc v_sp = new CStoredProc("pr_V_DM_NCC_By_Ma_Ncc");
        v_sp.addNVarcharInputParam("@ip_str_ma_ncc", ip_str_ma_ncc);
