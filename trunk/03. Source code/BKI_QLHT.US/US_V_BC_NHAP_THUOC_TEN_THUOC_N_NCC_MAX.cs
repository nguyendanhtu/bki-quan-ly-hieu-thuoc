///************************************************
/// Generated by: TuNA
/// Date: 25-05-2014 06:07:41
/// Goal: Create User Service Class for V_BC_NHAP_THUOC_TEN_THUOC_N_NCC_MAX
///************************************************
/// <summary>
/// Create User Service Class for V_BC_NHAP_THUOC_TEN_THUOC_N_NCC_MAX
/// </summary>
...
public class US_V_BC_NHAP_THUOC_TEN_THUOC_N_NCC_MAX : US_Object
{
	private const string c_TableName = "V_BC_NHAP_THUOC_TEN_THUOC_N_NCC_MAX";
#region "Public Properties"
	...
	public decimal dcGIA_NHAP_MAX 
	{
		get
		{
			return CNull.RowNVLDecimal(pm_objDR, "GIA_NHAP_MAX", IPConstants.c_DefaultDecimal);
		}
		set	
		{
			pm_objDR["GIA_NHAP_MAX"] = value;
		}
	}

	public bool IsGIA_NHAP_MAXNull()	{
		return pm_objDR.IsNull("GIA_NHAP_MAX");
	}

	public void SetGIA_NHAP_MAXNull() {
		pm_objDR["GIA_NHAP_MAX"] = System.Convert.DBNull;
	}
...
#region "Init Functions"
    public void FillDatasetSearch(BKI_QLHT.DS.DS_V_BC_NHAP_THUOC_TEN_THUOC_N_NCC_MAX op_ds_bc_da, string i_str_tu_khoa, DateTime i_dat_ngay_bd, DateTime i_dat_ngay_kt)
    {
        CStoredProc v_sp = new CStoredProc("pr_V_BC_NHAP_THUOC_TEN_THUOC_N_NCC_MAX_search");
	...
	public US_V_BC_NHAP_THUOC_TEN_THUOC_N_NCC_MAX() 
	{
		pm_objDS = new DS_V_BC_NHAP_THUOC_TEN_THUOC_N_NCC_MAX();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_BC_NHAP_THUOC_TEN_THUOC_N_NCC_MAX(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_BC_NHAP_THUOC_TEN_THUOC_N_NCC_MAX(decimal i_dbID) 
	{
		pm_objDS = new DS_V_BC_NHAP_THUOC_TEN_THUOC_N_NCC_MAX();
		pm_strTableName = c_TableName;
