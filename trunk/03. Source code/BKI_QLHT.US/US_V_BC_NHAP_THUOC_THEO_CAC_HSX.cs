///************************************************
/// Generated by: TuNA
/// Date: 17-05-2014 11:15:10
/// Goal: Create User Service Class for V_BC_NHAP_THUOC_THEO_CAC_HSX
///************************************************
/// <summary>
/// Create User Service Class for V_BC_NHAP_THUOC_THEO_CAC_HSX
/// </summary>
...
public class US_V_BC_NHAP_THUOC_THEO_CAC_HSX : US_Object
{
	private const string c_TableName = "V_BC_NHAP_THUOC_THEO_CAC_HSX";
...
#region "Init Functions"
    public void FillDatasetSearch(DS_V_BC_NHAP_THUOC_THEO_CAC_HSX op_ds_bc_da, string i_str_tu_khoa, DateTime i_dat_ngay_bd, DateTime i_dat_ngay_kt)
    {
        CStoredProc v_sp = new CStoredProc("pr_V_BC_NHAP_THUOC_CAC_HSX_search");
	...
	public US_V_BC_NHAP_THUOC_THEO_CAC_HSX() 
	{
		pm_objDS = new DS_V_BC_NHAP_THUOC_THEO_CAC_HSX();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_BC_NHAP_THUOC_THEO_CAC_HSX(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_BC_NHAP_THUOC_THEO_CAC_HSX(decimal i_dbID) 
	{
		pm_objDS = new DS_V_BC_NHAP_THUOC_THEO_CAC_HSX();
		pm_strTableName = c_TableName;
