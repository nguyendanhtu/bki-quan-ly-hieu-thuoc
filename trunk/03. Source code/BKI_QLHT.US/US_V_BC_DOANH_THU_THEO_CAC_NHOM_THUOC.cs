///************************************************
/// Generated by: TuNA
/// Date: 15-05-2014 01:18:10
/// Goal: Create User Service Class for V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC
///************************************************
/// <summary>
/// Create User Service Class for V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC
/// </summary>
...
public class US_V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC : US_Object
{
	private const string c_TableName = "V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC";
...
#region "Init Functions"
    public void FillDatasetSearch(DS_V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC op_ds_bc_da, string i_str_tu_khoa, DateTime i_dat_ngay_bd, DateTime i_dat_ngay_kt)
    {
        CStoredProc v_sp = new CStoredProc("pr_V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_search");
	...
	public US_V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC() 
	{
		pm_objDS = new DS_V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC(decimal i_dbID) 
	{
		pm_objDS = new DS_V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC();
		pm_strTableName = c_TableName;
