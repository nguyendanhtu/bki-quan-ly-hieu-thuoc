///************************************************
/// Generated by: TuNA
/// Date: 15-05-2014 01:16:59
/// Goal: Create User Service Class for V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG
///************************************************
/// <summary>
/// Create User Service Class for V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG
/// </summary>
...
public class US_V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG : US_Object
{
	private const string c_TableName = "V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG";
...
#region "Init Functions"
    public void FillDatasetSearch(DS_V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG op_ds_bc_da, string i_str_tu_khoa, DateTime i_dat_ngay_bd, DateTime i_dat_ngay_kt)
    {
        CStoredProc v_sp = new CStoredProc("pr_V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG_search");
	...
	public US_V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG() 
	{
		pm_objDS = new DS_V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG(decimal i_dbID) 
	{
		pm_objDS = new DS_V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG();
		pm_strTableName = c_TableName;
