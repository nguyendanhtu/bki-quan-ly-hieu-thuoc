///************************************************
/// Generated by: TuNA
/// Date: 30-04-2014 11:55:57
/// Goal: Create Form for V_DM_NCC
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f405_v_dm_ncc : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f405_v_dm_ncc));
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(686, 312);
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(517, 18);
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(150, 23);
            ...
            this.Name = "f405_v_dm_ncc";
            this.Text = "f405_v_dm_ncc";
            this.Load += new System.EventHandler(this.f405_v_dm_ncc_Load);
...
,MA_NCC = 1
        ...
        DS_V_DM_NCC m_v_ds = new DS_V_DM_NCC();
        US_V_DM_NCC m_v_us = new US_V_DM_NCC();
        DS_DM_NCC_NSX_NHASX m_ds = new DS_DM_NCC_NSX_NHASX();
        US_DM_NCC_NSX_NHASX m_us = new US_DM_NCC_NSX_NHASX();
        ...
        {
            int count = m_v_ds.Tables["V_DM_NCC"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_DM_NCC)
            {
                v_acsc_search.Add(dr[V_DM_NCC.TEN_NCC].ToString());
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_DM_NCC.TEN_NCC, e_col_Number.TEN_NCC);
			v_htb.Add(V_DM_NCC.DIA_CHI, e_col_Number.DIA_CHI);
			v_htb.Add(V_DM_NCC.SDT, e_col_Number.SDT);
			v_htb.Add(V_DM_NCC.MA_NCC, e_col_Number.MA_NCC);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_DM_NCC.NewRow());
			return v_obj_trans;			
		}
		...
		private void grid2us_object(US_V_DM_NCC i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_DM_NCC i_us
			, int i_grid_row) {
		...
		private void insert_v_dm_ncc(){			
		//	f405_v_dm_ncc_DE v_fDE = new  f405_v_dm_ncc_DE();								
		//	v_fDE.display();
			load_data_2_grid();
		}

		private void update_v_dm_ncc(){			
		...
		private void delete_v_dm_ncc(){
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			if (BaseMessages.askUser_DataCouldBeDeleted(8) != BaseMessages.IsDataCouldBeDeleted.CouldBeDeleted)  return;
			US_V_DM_NCC v_us = new US_V_DM_NCC();
...
//
		...
		//
		//
		private void f405_v_dm_ncc_Load(object sender, System.EventArgs e) {
			try{
