...
namespace BKI_QLHT
{
	...
	public class f410_bao_cao_danh_muc_thuoc_theo_ncc : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(f410_bao_cao_danh_muc_thuoc_theo_ncc));
			...
			// m_fg
			// 
			this.m_fg.ColumnInfo = @"10,1,0,0,0,85,Columns:0{Width:13;}	 3{Caption:""TT thuốc"";Visible:True;DataType:System.Decimal;TextAlign:RightCenter;TextAlignFixed:CenterCenter;}9{Caption:""Tuyến sử dung 8"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}8{Caption:""Tuyến sử dụng 7"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}7{Caption:""Tuyến sử dụng 6"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}2{Caption:""TT hoạt chất"";Visible:True;DataType:System.Decimal;TextAlign:RightCenter;TextAlignFixed:CenterCenter;}6{Caption:""Tuyến sử dụng 5"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}5{Caption:""Đường dụng, dạng dùng"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}1{Caption:""Tên nhà cung cấp"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}4{Caption:""Tên thuốc hay hoạt chất"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}	";
...
,TEN_THUOC = 4
		...
		DS_V_BAO_CAO_DANH_MUC_THUOC_THEO_NCC m_ds = new DS_V_BAO_CAO_DANH_MUC_THUOC_THEO_NCC();
		US_V_BAO_CAO_DANH_MUC_THUOC_THEO_NCC m_us = new US_V_BAO_CAO_DANH_MUC_THUOC_THEO_NCC();
		#endregion
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_ds.V_BAO_CAO_DANH_MUC_THUOC_THEO_NCC.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){						
			m_ds = new DS_V_BAO_CAO_DANH_MUC_THUOC_THEO_NCC();			
		...
		private void insert_v_bao_cao_danh_muc_thuoc_theo_ncc(){			
		//	f410_bao_cao_danh_muc_thuoc_theo_ncc_DE v_fDE = new  f410_bao_cao_danh_muc_thuoc_theo_ncc_DE();								
		//	v_fDE.display();
			load_data_2_grid();
		}

		private void update_v_bao_cao_danh_muc_thuoc_theo_ncc(){			
		...
		private void delete_v_bao_cao_danh_muc_thuoc_theo_ncc(){
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			if (BaseMessages.askUser_DataCouldBeDeleted(8) != BaseMessages.IsDataCouldBeDeleted.CouldBeDeleted)  return;
			US_V_BAO_CAO_DANH_MUC_THUOC_THEO_NCC v_us = new US_V_BAO_CAO_DANH_MUC_THUOC_THEO_NCC();
		...
		private void view_v_bao_cao_danh_muc_thuoc_theo_ncc(){			
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			grid2us_object(m_us, m_fg.Row);
		//	f410_bao_cao_danh_muc_thuoc_theo_ncc_DE v_fDE = new f410_bao_cao_danh_muc_thuoc_theo_ncc_DE();			
...
//
		...
		private void m_cmd_insert_Click(object sender, EventArgs e) {
			try{
				insert_v_bao_cao_danh_muc_thuoc_theo_ncc();
			}
			catch (Exception v_e){
				CSystemLog_301.ExceptionHandle(v_e);
			}
		...
		private void m_cmd_update_Click(object sender, EventArgs e) {
			try{
				update_v_bao_cao_danh_muc_thuoc_theo_ncc();
			}
			catch (Exception v_e){
				CSystemLog_301.ExceptionHandle(v_e);
			}
		...
		private void m_cmd_delete_Click(object sender, EventArgs e) {
			try{
				delete_v_bao_cao_danh_muc_thuoc_theo_ncc();
			}
			catch (Exception v_e){
				CSystemLog_301.ExceptionHandle(v_e);
			}
		...
		private void m_cmd_view_Click(object sender, EventArgs e) {
			try{
				view_v_bao_cao_danh_muc_thuoc_theo_ncc();
			}
			catch (Exception v_e){
				CSystemLog_301.ExceptionHandle(v_e);
			}
