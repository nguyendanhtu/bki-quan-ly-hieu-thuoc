///************************************************
/// Generated by: TuNA
/// Date: 15-05-2014 01:20:21
/// Goal: Create Form for V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_N_TEN_THUOC
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f420_bcdt_theo_cac_nhom_thuoc_n_ten_thuoc : System.Windows.Forms.Form
	{
		...
		public f420_bcdt_theo_cac_nhom_thuoc_n_ten_thuoc()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f420_bcdt_theo_cac_nhom_thuoc_n_ten_thuoc));
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(918, 247);
            ...
            this.m_cmd_xuat_excel.TabIndex = 36;
            this.m_cmd_xuat_excel.Text = "Xuất ra Excel";
            // 
            // label7
            // 
            this.label7.AutoSize = true;
            this.label7.Location = new System.Drawing.Point(476, 51);
            this.label7.Name = "label7";
            this.label7.Size = new System.Drawing.Size(53, 13);
            this.label7.TabIndex = 2891;
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(546, 45);
            ...
            this.m_dat_den_ngay.TabIndex = 2890;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(672, 9);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 2886;
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(186, 104);
            this.m_lbl_doanh_thu.Name = "m_lbl_doanh_thu";
            this.m_lbl_doanh_thu.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_doanh_thu.TabIndex = 2880;
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(186, 82);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 2878;
            ...
            this.label1.TabIndex = 2877;
            this.label1.Text = "Số kết quả trong báo cáo";
            // 
            // f420_bcdt_theo_cac_nhom_thuoc_n_ten_thuoc
            // 
            ...
            this.Name = "f420_bcdt_theo_cac_nhom_thuoc_n_ten_thuoc";
            this.Text = "f420_bcdt_theo_cac_nhom_thuoc_n_ten_thuoc";
            this.Load += new System.EventHandler(this.f420_bcdt_theo_cac_nhom_thuoc_n_ten_thuoc_Load);
...
,TEN_NHOM_THUOC = 1
		...
		DS_V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_n_TEN_THUOC m_v_ds = new DS_V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_n_TEN_THUOC();
		US_V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_N_TEN_THUOC m_v_us = new US_V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_N_TEN_THUOC();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_N_TEN_THUOC"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_n_TEN_THUOC)
            {
                v_acsc_search.Add(dr[V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_n_TEN_THUOC.TEN_NHOM_THUOC].ToString());
                v_acsc_search.Add(dr[V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_n_TEN_THUOC.TEN_THUOC].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_n_TEN_THUOC.TONG_SO_LUONG_BAN, e_col_Number.TONG_SO_LUONG_BAN);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_n_TEN_THUOC.DON_VI_TINH, e_col_Number.DON_VI_TINH);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_n_TEN_THUOC.DOANH_THU, e_col_Number.DOANH_THU);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_n_TEN_THUOC.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_n_TEN_THUOC.TEN_THUOC, e_col_Number.TEN_THUOC);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_n_TEN_THUOC.TEN_NHOM_THUOC, e_col_Number.TEN_NHOM_THUOC);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_n_TEN_THUOC.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds.V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_n_TEN_THUOC.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_n_TEN_THUOC.DOANH_THU]);
            }
            ...
            m_lbl_count.Text = m_v_ds.V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_n_TEN_THUOC.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_N_TEN_THUOC i_us
			, int i_grid_row) {
			DataRow v_dr;
			v_dr = (DataRow) m_fg.Rows[i_grid_row].UserData;
			m_obj_trans.GridRow2DataRow(i_grid_row,v_dr);
		...
		private void us_object2grid(US_V_BC_DOANH_THU_THEO_CAC_NHOM_THUOC_N_TEN_THUOC i_us
			, int i_grid_row) {
...
//
		...
		//
		//
		private void f420_bcdt_theo_cac_nhom_thuoc_n_ten_thuoc_Load(object sender, System.EventArgs e) {
			try{
