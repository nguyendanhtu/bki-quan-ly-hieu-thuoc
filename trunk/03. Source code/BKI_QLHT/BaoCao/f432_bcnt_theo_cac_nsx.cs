///************************************************
/// Generated by: TuNA
/// Date: 20-05-2014 01:43:08
/// Goal: Create Form for V_BC_NHAP_THUOC_THEO_CAC_NSX
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f432_bcnt_theo_cac_nsx : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f432_bcnt_theo_cac_nsx));
            ...
            this.m_pnl_out_place_dm.Size = new System.Drawing.Size(745, 36);
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(745, 241);
            ...
            this.m_lbl_nguoi_lam_bc.Location = new System.Drawing.Point(679, 84);
            ...
            this.m_lbl_ngay_lam_bc.Location = new System.Drawing.Point(679, 106);
            ...
            this.label3.Location = new System.Drawing.Point(562, 106);
            ...
            this.m_lbl_nguoi_lam_bao_cao.Location = new System.Drawing.Point(562, 84);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(172, 106);
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(172, 84);
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(452, 47);
            ...
            this.m_dat_tu_ngay.Location = new System.Drawing.Point(157, 47);
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(578, 11);
            ...
            this.Name = "f432_bcnt_theo_cac_nsx";
            this.Text = "f432_bcnt_theo_cac_nsx";
            this.Load += new System.EventHandler(this.f432_bcnt_theo_cac_nsx_Load);
...
,DON_VI_TINH = 4
		...
		DS_V_BC_NHAP_THUOC_THEO_CAC_NSX m_v_ds = new DS_V_BC_NHAP_THUOC_THEO_CAC_NSX();
		US_V_BC_NHAP_THUOC_THEO_CAC_NSX m_v_us = new US_V_BC_NHAP_THUOC_THEO_CAC_NSX();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_NHAP_THUOC_THEO_CAC_NSX"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NSX)
            {
                v_acsc_search.Add(dr[V_BC_NHAP_THUOC_THEO_CAC_NSX.TEN_NSX].ToString());
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NSX.TEN_NSX, e_col_Number.TEN_NSX);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NSX.THANH_TIEN, e_col_Number.THANH_TIEN);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NSX.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NSX.TONG_SO_LUONG_NHAP, e_col_Number.TONG_SO_LUONG_NHAP);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NSX.DON_VI_TINH, e_col_Number.DON_VI_TINH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NSX.NewRow());
			return v_obj_trans;			
		}
        private void load_data_2_grid()
        {
            ...
            for (int i = 0; i < m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NSX.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_NHAP_THUOC_THEO_CAC_NSX.THANH_TIEN]);
            }
            ...
            m_lbl_count.Text = m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NSX.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_NHAP_THUOC_THEO_CAC_NSX i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_NHAP_THUOC_THEO_CAC_NSX i_us
			, int i_grid_row) {
...
//
		...
		//
		//
		private void f432_bcnt_theo_cac_nsx_Load(object sender, System.EventArgs e) {
			try{
