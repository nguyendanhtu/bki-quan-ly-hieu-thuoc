///************************************************
/// Generated by: TuNA
/// Date: 05-05-2014 11:58:58
/// Goal: Create Form for V_BAO_CAO_DANH_MUC_KHACH_HANG
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f414_bao_cao_danh_muc_khach_hang : System.Windows.Forms.Form
	{
		...
		public f414_bao_cao_danh_muc_khach_hang()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f414_bao_cao_danh_muc_khach_hang));
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(850, 237);
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(162, 109);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 2747;
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(618, 42);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 2749;
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(197, 47);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(401, 20);
            this.m_txt_tim_kiem.TabIndex = 2748;
            // 
            // label4
            // 
            ...
            this.label4.Text = "Báo cáo danh mục khách hàng";
            // 
            // f414_bao_cao_danh_muc_khach_hang
            // 
            ...
            this.Name = "f414_bao_cao_danh_muc_khach_hang";
            this.Text = "F414-Báo cáo danh mục khách hàng";
            this.Load += new System.EventHandler(this.f414_bao_cao_danh_muc_khach_hang_Load);
...
,MA_SO_THUE = 5
		...
		DS_V_BAO_CAO_DANH_MUC_KHACH_HANG m_v_ds = new DS_V_BAO_CAO_DANH_MUC_KHACH_HANG();
		US_V_BAO_CAO_DANH_MUC_KHACH_HANG m_v_us = new US_V_BAO_CAO_DANH_MUC_KHACH_HANG();
		#endregion
        ...
        private void load_custom_source_2_m_txt_tim_kiem()
        {
            ...
            foreach (DataRow dr in m_v_ds.V_BAO_CAO_DANH_MUC_KHACH_HANG)
            {
                v_acsc_search.Add(dr[V_BAO_CAO_DANH_MUC_KHACH_HANG.TEN_NHOM].ToString());
                v_acsc_search.Add(dr[V_BAO_CAO_DANH_MUC_KHACH_HANG.TEN_KHACH_HANG].ToString());
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BAO_CAO_DANH_MUC_KHACH_HANG.TI_LE_CHIET_KHAU_NHOM_KH, e_col_Number.TI_LE_CHIET_KHAU_NHOM_KH);
			v_htb.Add(V_BAO_CAO_DANH_MUC_KHACH_HANG.DIA_CHI, e_col_Number.DIA_CHI);
			v_htb.Add(V_BAO_CAO_DANH_MUC_KHACH_HANG.TEN_KHACH_HANG, e_col_Number.TEN_KHACH_HANG);
			v_htb.Add(V_BAO_CAO_DANH_MUC_KHACH_HANG.TEN_NHOM, e_col_Number.TEN_NHOM);
			v_htb.Add(V_BAO_CAO_DANH_MUC_KHACH_HANG.SDT, e_col_Number.SDT);
			v_htb.Add(V_BAO_CAO_DANH_MUC_KHACH_HANG.MA_SO_THUE, e_col_Number.MA_SO_THUE);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BAO_CAO_DANH_MUC_KHACH_HANG.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            m_lbl_count.Text = m_v_ds.V_BAO_CAO_DANH_MUC_KHACH_HANG.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BAO_CAO_DANH_MUC_KHACH_HANG i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BAO_CAO_DANH_MUC_KHACH_HANG i_us
			, int i_grid_row) {
		...
		private void set_define_events(){
            ...
            this.KeyDown += new KeyEventHandler(f414_bao_cao_danh_muc_khach_hang_KeyDown);
		}
...
//
		...
		//
		//
		private void f414_bao_cao_danh_muc_khach_hang_Load(object sender, System.EventArgs e) {
			try{
        ...
        private void f414_bao_cao_danh_muc_khach_hang_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
