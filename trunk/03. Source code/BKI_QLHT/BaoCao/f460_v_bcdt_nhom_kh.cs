///************************************************
/// Generated by: TuNA
/// Date: 26-05-2014 11:47:35
/// Goal: Create Form for V_BC_DOANH_THU_NHOM_KH
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f460_v_bcdt_nhom_kh : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f460_v_bcdt_nhom_kh));
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(171, 136);
            ...
            this.m_lbl_nguoi_lam_bc.Location = new System.Drawing.Point(596, 114);
            ...
            this.m_lbl_ngay_lam_bc.Location = new System.Drawing.Point(596, 136);
            ...
            this.m_lbl_nguoi_lam_bao_cao.Location = new System.Drawing.Point(479, 114);
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(171, 114);
            ...
            this.label7.Location = new System.Drawing.Point(380, 83);
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(450, 77);
            ...
            this.m_dat_tu_ngay.Location = new System.Drawing.Point(155, 77);
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(576, 41);
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(155, 46);
            ...
            this.label4.Text = "Báo cáo doanh thu theo nhóm khách hàng";
            // 
            // f460_v_bcdt_nhom_kh
            // 
            ...
            this.Name = "f460_v_bcdt_nhom_kh";
            this.Text = "F460-Báo cáo doanh thu theo nhóm khách hàng";
            this.Load += new System.EventHandler(this.f460_v_bcdt_nhom_kh_Load);
...
,DOANH_THU = 3
		...
		US_V_BC_DOANH_THU_NHOM_KH m_v_us = new US_V_BC_DOANH_THU_NHOM_KH();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_DOANH_THU_NHOM_KH"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds._V_BC_DOANH_THU_NHOM_KH)
            {
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_NHOM_KH.TEN_NHOM_KH].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
            ...
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_NHOM_KH.TEN_NHOM_KH, e_col_Number.TEN_NHOM_KH);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_NHOM_KH.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_NHOM_KH.DOANH_THU, e_col_Number.DOANH_THU);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds._V_BC_DOANH_THU_NHOM_KH.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds._V_BC_DOANH_THU_NHOM_KH.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][BKI_QLHT.DS.CDBNames
                .V_BC_DOANH_THU_NHOM_KH.DOANH_THU]);
            }
            ...
            m_lbl_count.Text = m_v_ds._V_BC_DOANH_THU_NHOM_KH.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_DOANH_THU_NHOM_KH i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_DOANH_THU_NHOM_KH i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f460_bao_cao_doanh_thu_theo_nhom_khach_hang.xlsx", 10, 1);
            //người làm báo cáo
...
//
		...
		//
		//
		private void f460_v_bcdt_nhom_kh_Load(object sender, System.EventArgs e) {
			try{
