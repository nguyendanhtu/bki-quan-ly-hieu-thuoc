///************************************************
/// Generated by: TuNA
/// Date: 20-05-2014 01:43:46
/// Goal: Create Form for V_BC_NHAP_THUOC_THEO_CAC_NSX_DE
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f432_bcnt_theo_cac_nsx_de : System.Windows.Forms.Form
	{
		...
		public f432_bcnt_theo_cac_nsx_de()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f432_bcnt_theo_cac_nsx_de));
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(878, 246);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(167, 107);
            this.m_lbl_doanh_thu.Name = "m_lbl_doanh_thu";
            this.m_lbl_doanh_thu.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_doanh_thu.TabIndex = 2902;
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(167, 85);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 2900;
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(447, 48);
            ...
            this.m_dat_den_ngay.TabIndex = 2897;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(573, 12);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 2893;
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(152, 17);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(401, 20);
            this.m_txt_tim_kiem.TabIndex = 2892;
            // 
            // f432_bcnt_theo_cac_nsx_de
            // 
            ...
            this.Name = "f432_bcnt_theo_cac_nsx_de";
            this.Text = "f432_bcnt_theo_cac_nsx_de";
            this.Load += new System.EventHandler(this.f432_bcnt_theo_cac_nsx_de_Load);
...
,DON_VI_TINH = 5
        ...
        private const String m_str_tim_kiem = "Nhập tên nước sản xuất, tên thuốc cần tìm";
        DateTime v_dat_ngay_bd;
        DateTime v_dat_ngay_kt;
		DS_V_BC_NHAP_THUOC_THEO_CAC_NSX_de m_v_ds = new DS_V_BC_NHAP_THUOC_THEO_CAC_NSX_de();
		US_V_BC_NHAP_THUOC_THEO_CAC_NSX_DE m_v_us = new US_V_BC_NHAP_THUOC_THEO_CAC_NSX_DE();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_NHAP_THUOC_THEO_CAC_NSX_DE"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NSX_de)
            {
                v_acsc_search.Add(dr[V_BC_NHAP_THUOC_THEO_CAC_NSX_de.TEN_NSX].ToString());
                v_acsc_search.Add(dr[V_BC_NHAP_THUOC_THEO_CAC_NSX_de.TEN_THUOC].ToString());
            }
        ...
        private void format_controls()
        {
            ...
            m_fg.Cols[(int)e_col_Number.TEN_NSX].Visible = false;
        ...
        private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg)
        {
            ...
            v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NSX_de.THANH_TIEN, e_col_Number.THANH_TIEN);
            v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NSX_de.TONG_SO_LUONG_NHAP, e_col_Number.TONG_SO_LUONG_NHAP);
            v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NSX_de.TEN_NSX, e_col_Number.TEN_NSX);
            v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NSX_de.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
            v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NSX_de.TEN_THUOC, e_col_Number.TEN_THUOC);
            v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NSX_de.DON_VI_TINH, e_col_Number.DON_VI_TINH);

            ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg, v_htb, m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NSX_de.NewRow());
            return v_obj_trans;
        }
        private void load_data_2_grid()
        {
            ...
            for (int i = 0; i < m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NSX_de.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_NHAP_THUOC_THEO_CAC_NSX_de.THANH_TIEN]);
            }
            ...
            m_fg.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Count // chỗ này dùng hàm count tức là để đếm, có thể dùng các hàm khác thay thế
              , 0
              , (int)e_col_Number.TEN_NSX // chỗ này là tên trường mà mình nhóm
              , (int)e_col_Number.NGAY_GIAO_DICH // chỗ này là tên trường mà mình Count
              , "{0}"
              );
            m_fg.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum
                , 0
                , (int)e_col_Number.TEN_NSX
                , (int)e_col_Number.THANH_TIEN
                , "{0}"
                );
            m_lbl_count.Text = m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NSX_de.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
        ...
        private void grid2us_object(US_V_BC_NHAP_THUOC_THEO_CAC_NSX_DE i_us
            , int i_grid_row)
        {
            DataRow v_dr;
        ...
        private void us_object2grid(US_V_BC_NHAP_THUOC_THEO_CAC_NSX_DE i_us
            , int i_grid_row)
        {
...
//
		...
		//
		//
		private void f432_bcnt_theo_cac_nsx_de_Load(object sender, System.EventArgs e) {
			try{
