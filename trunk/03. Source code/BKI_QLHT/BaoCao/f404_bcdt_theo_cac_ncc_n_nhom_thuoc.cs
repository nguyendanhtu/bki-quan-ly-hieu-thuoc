///************************************************
/// Generated by: TuNA
/// Date: 14-05-2014 10:41:20
/// Goal: Create Form for V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f404_bcdt_theo_cac_ncc_n_nhom_thuoc : System.Windows.Forms.Form
	{
		...
		public f404_bcdt_theo_cac_ncc_n_nhom_thuoc()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f404_bcdt_theo_cac_ncc_n_nhom_thuoc));
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(912, 241);
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(569, 47);
            ...
            this.m_dat_tu_ngay.Location = new System.Drawing.Point(274, 47);
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(695, 11);
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(274, 16);
            ...
            this.m_lbl_nguoi_lam_bc.Location = new System.Drawing.Point(809, 86);
            ...
            this.m_lbl_ngay_lam_bc.Location = new System.Drawing.Point(809, 108);
            ...
            this.label3.Location = new System.Drawing.Point(692, 108);
            ...
            this.m_lbl_nguoi_lam_bao_cao.Location = new System.Drawing.Point(692, 86);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(196, 108);
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(196, 86);
            ...
            // 
            // f404_bcdt_theo_cac_ncc_n_nhom_thuoc
            // 
            ...
            this.Name = "f404_bcdt_theo_cac_ncc_n_nhom_thuoc";
            this.Text = "f404_bcdt_theo_cac_ncc_n_nhom_thuoc";
            this.Load += new System.EventHandler(this.f404_bcdt_theo_cac_ncc_n_nhom_thuoc_Load);
...
,TEN_NHOM_THUOC = 2
        ...
        private const String m_str_tim_kiem = "Nhập tên nhà cung cấp, tên nhóm thuốc cần tìm";
        DateTime v_dat_ngay_bd;
        DateTime v_dat_ngay_kt;
        DS_V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC m_v_ds = new DS_V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC();
        US_V_BC_DOANH_THU_THEO_CAC_NCC_N_NHOM_THUOC m_v_us = new US_V_BC_DOANH_THU_THEO_CAC_NCC_N_NHOM_THUOC();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC)
            {
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC.TEN_NCC].ToString());
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC.TEN_NHOM_THUOC].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC.TEN_NCC, e_col_Number.TEN_NCC);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC.DON_VI_TINH, e_col_Number.DON_VI_TINH);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC.DOANH_THU, e_col_Number.DOANH_THU);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC.TONG_SO_LUONG_BAN, e_col_Number.TONG_SO_LUONG_BAN);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC.TEN_NHOM_THUOC, e_col_Number.TEN_NHOM_THUOC);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC.NewRow());
			return v_obj_trans;			
		}
            ...
            for (int i = 0; i < m_v_ds.V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC.DOANH_THU]);
            }
            ...
            m_fg.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Count // chỗ này dùng hàm count tức là để đếm, có thể dùng các hàm khác thay thế
              ...
              , (int)e_col_Number.TEN_NHOM_THUOC // chỗ này là tên trường mà mình Count
              , "{0}"
              );
            ...
            m_lbl_count.Text = m_v_ds.V_BC_DOANH_THU_THEO_CAC_NCC_n_NHOM_THUOC.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_DOANH_THU_THEO_CAC_NCC_N_NHOM_THUOC i_us
			, int i_grid_row) {
			DataRow v_dr;
        ...
        private void us_object2grid(US_V_BC_DOANH_THU_THEO_CAC_NCC_N_NHOM_THUOC i_us, int i_grid_row)
        {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f404_bao_cao_doanh_thu_theo_cac_ncc_va_nhom_thuoc.xlsx", 10, 1);
            //người làm báo cáo
...
//
		...
		//
		//
		private void f404_bcdt_theo_cac_ncc_n_nhom_thuoc_Load(object sender, System.EventArgs e) {
			try{
