///************************************************
/// Generated by: TuNA
/// Date: 24-05-2014 02:10:41
/// Goal: Create Form for V_BC_NHAP_THUOC_NCC_DE
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f455_bcnt_ncc_de : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f455_bcnt_ncc_de));
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(686, 208);
            ...
            this.m_lbl_nguoi_lam_bc.Location = new System.Drawing.Point(596, 113);
            ...
            this.m_lbl_ngay_lam_bc.Location = new System.Drawing.Point(596, 135);
            ...
            this.m_lbl_nguoi_lam_bao_cao.Location = new System.Drawing.Point(479, 113);
            ...
            this.label4.Text = "Báo cáo nhập thuốc chi tiết theo nhà cung cấp";
            // 
            // f455_bcnt_ncc_de
            // 
            ...
            this.Name = "f455_bcnt_ncc_de";
            this.Text = "F455-Báo cáo nhập thuốc chi tiết theo nhà cung cấp";
            this.Load += new System.EventHandler(this.f455_bcnt_ncc_de_Load);
...
,THANH_TIEN = 5
        ...
        private const String m_str_tim_kiem = "Nhập tên nhà cung cấp, mã giao dịch cần tìm";
        DateTime v_dat_ngay_bd;
        DateTime v_dat_ngay_kt;
        BKI_QLHT.DS.V_BC_NHAP_THUOC_NCC_DE m_v_ds = new BKI_QLHT.DS.V_BC_NHAP_THUOC_NCC_DE();
		US_V_BC_NHAP_THUOC_NCC_DE m_v_us = new US_V_BC_NHAP_THUOC_NCC_DE();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_NHAP_THUOC_NCC_DE"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds._V_BC_NHAP_THUOC_NCC_DE)
            {
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NCC_DE.MA_GIAO_DICH].ToString());
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NCC_DE.TEN_NCC].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
            ...
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NCC_DE.TEN_NCC, e_col_Number.TEN_NCC);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NCC_DE.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NCC_DE.MA_GIAO_DICH, e_col_Number.MA_GIAO_DICH);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NCC_DE.TEN_THUOC, e_col_Number.TEN_THUOC);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NCC_DE.THANH_TIEN, e_col_Number.THANH_TIEN);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds._V_BC_NHAP_THUOC_NCC_DE.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds._V_BC_NHAP_THUOC_NCC_DE.Count; i++)
            {
            ...
            m_lbl_count.Text = m_v_ds._V_BC_NHAP_THUOC_NCC_DE.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_NHAP_THUOC_NCC_DE i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_NHAP_THUOC_NCC_DE i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f455_bao_cao_nhap_thuoc_chi_tiet_theo_nha_cung_cap.xlsx", 10, 1);
            //người làm báo cáo
        ...
        private void set_define_events()
        {
            ...
            this.KeyDown += new KeyEventHandler(f455_bcnt_ncc_de_KeyDown);
        }

       private void f455_bcnt_ncc_de_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
...
//
		...
		//
		//
		private void f455_bcnt_ncc_de_Load(object sender, System.EventArgs e) {
			try{
