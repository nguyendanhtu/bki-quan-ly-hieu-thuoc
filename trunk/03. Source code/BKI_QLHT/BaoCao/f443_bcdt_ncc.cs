///************************************************
/// Generated by: TuNA
/// Date: 23-05-2014 03:32:58
/// Goal: Create Form for V_BC_DOANH_THU_NCC
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f443_bcdt_ncc : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f443_bcdt_ncc));
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(168, 139);
            this.m_lbl_doanh_thu.Name = "m_lbl_doanh_thu";
            this.m_lbl_doanh_thu.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_doanh_thu.TabIndex = 2944;
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(168, 117);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 2938;
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(447, 80);
            ...
            this.m_dat_den_ngay.TabIndex = 2935;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(573, 44);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 2931;
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(152, 49);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(401, 20);
            this.m_txt_tim_kiem.TabIndex = 2930;
            // 
            // label4
            // 
            ...
            this.Name = "f443_bcdt_ncc";
            this.Text = "F443-Báo cáo doanh thu theo nhà cung cấp";
            this.Load += new System.EventHandler(this.f443_bcdt_ncc_Load);
...
,NGAY_GIAO_DICH = 2
        ...
        BKI_QLHT.DS.V_BC_DOANH_THU_NCC m_v_ds = new BKI_QLHT.DS.V_BC_DOANH_THU_NCC();
		US_V_BC_DOANH_THU_NCC m_v_us = new US_V_BC_DOANH_THU_NCC();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_DOANH_THU_NCC"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds._V_BC_DOANH_THU_NCC)
            {
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_NCC.TEN_NCC].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
            ...
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_NCC.TEN_NCC, e_col_Number.TEN_NCC);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_NCC.DOANH_THU, e_col_Number.DOANH_THU);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_NCC.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds._V_BC_DOANH_THU_NCC.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            m_lbl_count.Text = m_v_ds._V_BC_DOANH_THU_NCC.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_DOANH_THU_NCC i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_DOANH_THU_NCC i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f443_bao_cao_doanh_thu_theo_nha_cung_cap.xlsx", 10, 1);
            //người làm báo cáo
...
//
		...
		//
		//
		private void f443_bcdt_ncc_Load(object sender, System.EventArgs e) {
			try{
