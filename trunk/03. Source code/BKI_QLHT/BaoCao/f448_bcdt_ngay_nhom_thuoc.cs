///************************************************
/// Generated by: TuNA
/// Date: 23-05-2014 10:48:46
/// Goal: Create Form for V_BC_DOANH_THU_NGAY_NT
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f448_bcdt_ngay_nhom_thuoc : System.Windows.Forms.Form
	{
		...
		public f448_bcdt_ngay_nhom_thuoc()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f448_bcdt_ngay_nhom_thuoc));
            ...
            this.m_cmd_xuat_excel.TabIndex = 45;
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(173, 139);
            this.m_lbl_doanh_thu.Name = "m_lbl_doanh_thu";
            this.m_lbl_doanh_thu.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_doanh_thu.TabIndex = 3019;
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(173, 117);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 3013;
            ...
            this.label1.TabIndex = 3012;
            this.label1.Text = "Số kết quả trong báo cáo";
            // 
            // label7
            // 
            this.label7.AutoSize = true;
            this.label7.Location = new System.Drawing.Point(382, 86);
            this.label7.Name = "label7";
            this.label7.Size = new System.Drawing.Size(53, 13);
            this.label7.TabIndex = 3011;
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(452, 80);
            ...
            this.m_dat_den_ngay.TabIndex = 3010;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(578, 44);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 3006;
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(157, 49);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(401, 20);
            this.m_txt_tim_kiem.TabIndex = 3005;
            // 
            // label4
            // 
            ...
            this.label4.TabIndex = 3020;
            this.label4.Text = "Báo cáo doanh thu theo ngày và nhóm thuốc";
            // 
            // f448_bcdt_ngay_nhom_thuoc
            // 
            ...
            this.Name = "f448_bcdt_ngay_nhom_thuoc";
            this.Text = "F448-Báo cáo doanh thu theo ngày và nhóm thuốc";
            this.Load += new System.EventHandler(this.f448_bcdt_ngay_nhom_thuoc_Load);
...
,TEN_NHOM_THUOC = 2
        ...
        private const String m_str_tim_kiem = "Nhập nhóm thuốc cần tìm";
        DateTime v_dat_ngay_bd;
        DateTime v_dat_ngay_kt;
        BKI_QLHT.DS.V_BC_DOANH_THU_NGAY_NT m_v_ds = new BKI_QLHT.DS.V_BC_DOANH_THU_NGAY_NT();
		US_V_BC_DOANH_THU_NGAY_NT m_v_us = new US_V_BC_DOANH_THU_NGAY_NT();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_DOANH_THU_NGAY_NT"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds._V_BC_DOANH_THU_NGAY_NT)
            {
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_NGAY_NT.TEN_NHOM_THUOC].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
            ...
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_NGAY_NT.DOANH_THU, e_col_Number.DOANH_THU);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_NGAY_NT.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_NGAY_NT.TEN_NHOM_THUOC, e_col_Number.TEN_NHOM_THUOC);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds._V_BC_DOANH_THU_NGAY_NT.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds._V_BC_DOANH_THU_NGAY_NT.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][BKI_QLHT.DS.CDBNames
                .V_BC_DOANH_THU_NGAY_NT.DOANH_THU]);
            }
            ...
            m_lbl_count.Text = m_v_ds._V_BC_DOANH_THU_NGAY_NT.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_DOANH_THU_NGAY_NT i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_DOANH_THU_NGAY_NT i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f448_bao_cao_doanh_thu_ngay_va_nhom_thuoc.xlsx", 10, 1);
            //người làm báo cáo
        ...
        private void set_define_events()
        {
            ...
            this.KeyDown += new KeyEventHandler(f448_bcdt_ngay_nhom_thuoc_KeyDown);
        }

       private void f448_bcdt_ngay_nhom_thuoc_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
...
//
		...
		//
		//
		private void f448_bcdt_ngay_nhom_thuoc_Load(object sender, System.EventArgs e) {
			try{
