...
/// Goal: Create Form for V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f429_bcnt_cac_ngay_va_NCC : System.Windows.Forms.Form
	{
		...
		public f429_bcnt_cac_ngay_va_NCC()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f429_bcnt_cac_ngay_va_NCC));
            ...
            this.Name = "f429_bcnt_cac_ngay_va_NCC";
            this.Text = "f429_bcnt_cac_ngay_va_NCC";
            this.Load += new System.EventHandler(this.f429_bcnt_cac_ngay_va_NCC_Load);
...
,DON_VI_TINH = 4
		...
		DS_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC m_v_ds = new DS_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC();
		US_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC m_v_us = new US_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC();
		#endregion
        ...
        private void load_custom_source_2_m_txt_tim_kiem()
        {
            ...
            {
                v_acsc_search.Add(dr[V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC.TEN_NCC].ToString());
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC.THANH_TIEN, e_col_Number.THANH_TIEN);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC.TEN_NCC, e_col_Number.TEN_NCC);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC.TONG_SO_LUONG_NHAP, e_col_Number.TONG_SO_LUONG_NHAP);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC.DON_VI_TINH, e_col_Number.DON_VI_TINH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC.THANH_TIEN]);
            }
            ...
            m_lbl_count.Text = m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC i_us
			, int i_grid_row) {
...
//
		...
		//
		//
		private void f429_bcnt_cac_ngay_va_NCC_Load(object sender, System.EventArgs e) {
			try{
