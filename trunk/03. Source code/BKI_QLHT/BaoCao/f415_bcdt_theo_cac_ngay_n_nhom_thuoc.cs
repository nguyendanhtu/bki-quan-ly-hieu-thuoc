///************************************************
/// Generated by: TuNA
/// Date: 15-05-2014 12:52:14
/// Goal: Create Form for V_BC_DOANH_THU_THEO_CAC_NGAY_N_NHOM_THUOC
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f415_bcdt_theo_cac_ngay_n_nhom_thuoc : System.Windows.Forms.Form
	{
		...
		public f415_bcdt_theo_cac_ngay_n_nhom_thuoc()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f415_bcdt_theo_cac_ngay_n_nhom_thuoc));
            ...
            this.m_pnl_out_place_dm.Size = new System.Drawing.Size(775, 36);
            ...
            this.m_cmd_exit.Location = new System.Drawing.Point(683, 4);
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(775, 234);
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(487, 55);
            ...
            this.m_dat_den_ngay.TabIndex = 2830;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(613, 19);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 2826;
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(207, 116);
            this.m_lbl_doanh_thu.Name = "m_lbl_doanh_thu";
            this.m_lbl_doanh_thu.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_doanh_thu.TabIndex = 2820;
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(207, 94);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 2818;
            ...
            this.label1.TabIndex = 2817;
            this.label1.Text = "Số kết quả trong báo cáo";
            // 
            // f415_bcdt_theo_cac_ngay_n_nhom_thuoc
            // 
            ...
            this.Name = "f415_bcdt_theo_cac_ngay_n_nhom_thuoc";
            this.Text = "f415_bcdt_theo_cac_ngay_n_nhom_thuoc";
            this.Load += new System.EventHandler(this.f415_bcdt_theo_cac_ngay_n_nhom_thuoc_Load);
...
,TEN_NHOM_THUOC = 2
		...
		DS_V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHOM_THUOC m_v_ds = new DS_V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHOM_THUOC();
		US_V_BC_DOANH_THU_THEO_CAC_NGAY_N_NHOM_THUOC m_v_us = new US_V_BC_DOANH_THU_THEO_CAC_NGAY_N_NHOM_THUOC();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_DOANH_THU_THEO_CAC_NGAY_N_NHOM_THUOC"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHOM_THUOC)
            {
                v_acsc_search.Add(dr[V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHOM_THUOC.TEN_NHOM_THUOC].ToString());
            }
        ...
        private void format_controls()
        {
            ...
            m_fg.Tree.Column = (int)e_col_Number.TEN_NHOM_THUOC;
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHOM_THUOC.DON_VI_TINH, e_col_Number.DON_VI_TINH);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHOM_THUOC.DOANH_THU, e_col_Number.DOANH_THU);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHOM_THUOC.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHOM_THUOC.TONG_SO_LUONG_BAN, e_col_Number.TONG_SO_LUONG_BAN);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHOM_THUOC.TEN_NHOM_THUOC, e_col_Number.TEN_NHOM_THUOC);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHOM_THUOC.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds.V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHOM_THUOC.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHOM_THUOC.DOANH_THU]);
            }
            ...
            m_lbl_count.Text = m_v_ds.V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHOM_THUOC.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
        ...
        private void grid2us_object(US_V_BC_DOANH_THU_THEO_CAC_BAC_SY i_us
            , int i_grid_row)
        {
            DataRow v_dr;
		...
		private void grid2us_object(US_V_BC_DOANH_THU_THEO_CAC_NGAY_N_NHOM_THUOC i_us
			, int i_grid_row) {
			DataRow v_dr;
			v_dr = (DataRow) m_fg.Rows[i_grid_row].UserData;
			m_obj_trans.GridRow2DataRow(i_grid_row,v_dr);
		...
		private void us_object2grid(US_V_BC_DOANH_THU_THEO_CAC_NGAY_N_NHOM_THUOC i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f415_bao_cao_doanh_thu_theo_cac_ngay_va_nhom_thuoc.xlsx", 10, 1);
            //người làm báo cáo
...
//
		...
		//
		//
		private void f415_bcdt_theo_cac_ngay_n_nhom_thuoc_Load(object sender, System.EventArgs e) {
			try{
