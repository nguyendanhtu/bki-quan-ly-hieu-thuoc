///************************************************
/// Generated by: TuNA
/// Date: 09-05-2014 10:04:22
/// Goal: Create Form for V_BAO_CAO_DOANH_THU_THEO_NHOM_THUOC
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f416_bao_cao_doanh_thu_theo_nhom_thuoc : System.Windows.Forms.Form
	{
		...
		public f416_bao_cao_doanh_thu_theo_nhom_thuoc()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f416_bao_cao_doanh_thu_theo_nhom_thuoc));
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(765, 272);
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(166, 59);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 2753;
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(579, 15);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 2758;
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(158, 20);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(401, 20);
            this.m_txt_tim_kiem.TabIndex = 2757;
            // 
            // f416_bao_cao_doanh_thu_theo_nhom_thuoc
            // 
            ...
            this.Name = "f416_bao_cao_doanh_thu_theo_nhom_thuoc";
            this.Text = "f416_bao_cao_doanh_thu_theo_nhom_thuoc";
            this.Load += new System.EventHandler(this.f416_bao_cao_doanh_thu_theo_nhom_thuoc_Load);
...
,DOANH_THU = 4
		...
		DS_V_BAO_CAO_DOANH_THU_THEO_NHOM_THUOC m_v_ds = new DS_V_BAO_CAO_DOANH_THU_THEO_NHOM_THUOC();
		US_V_BAO_CAO_DOANH_THU_THEO_NHOM_THUOC m_v_us = new US_V_BAO_CAO_DOANH_THU_THEO_NHOM_THUOC();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BAO_CAO_DOANH_THU_THEO_NHOM_THUOC"].Rows.Count;
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BAO_CAO_DOANH_THU_THEO_NHOM_THUOC.SO_LUONG_BAN, e_col_Number.SO_LUONG_BAN);
			v_htb.Add(V_BAO_CAO_DOANH_THU_THEO_NHOM_THUOC.TEN_NHOM, e_col_Number.TEN_NHOM);
			v_htb.Add(V_BAO_CAO_DOANH_THU_THEO_NHOM_THUOC.TEN_THUOC, e_col_Number.TEN_THUOC);
			v_htb.Add(V_BAO_CAO_DOANH_THU_THEO_NHOM_THUOC.DOANH_THU, e_col_Number.DOANH_THU);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BAO_CAO_DOANH_THU_THEO_NHOM_THUOC.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            m_lbl_count.Text = m_v_ds.V_BAO_CAO_DOANH_THU_THEO_NHOM_THUOC.Count.ToString(CultureInfo.InvariantCulture);
            decimal v_dc_tong_doanh_thu =0;
            //m_v_us.get_tong_doanh_thu(v_dc_tong_doanh_thu);
            for (int i = 0; i < m_v_ds.V_BAO_CAO_DOANH_THU_THEO_NHOM_THUOC.Count;i++ )
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BAO_CAO_DOANH_THU_THEO_NHOM_THUOC.DOANH_THU]);
            }
		...
		private void grid2us_object(US_V_BAO_CAO_DOANH_THU_THEO_NHOM_THUOC i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BAO_CAO_DOANH_THU_THEO_NHOM_THUOC i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f416_bao_cao_doanh_thu_theo_nhom_thuoc.xlsx", 10, 1);
            //người làm báo cáo
...
//
		...
		//
		//
		private void f416_bao_cao_doanh_thu_theo_nhom_thuoc_Load(object sender, System.EventArgs e) {
			try{
