///************************************************
/// Generated by: TuNA
/// Date: 23-05-2014 02:33:29
/// Goal: Create Form for V_BC_DOANH_THU_BAC_SY_DE
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f441_bcdt_bac_sy_de : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f441_bcdt_bac_sy_de));
            ...
            this.m_pnl_control.Size = new System.Drawing.Size(738, 36);
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(738, 197);
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(165, 123);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 2908;
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(444, 86);
            ...
            this.m_dat_den_ngay.TabIndex = 2905;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(570, 50);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 2901;
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(149, 55);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(401, 20);
            this.m_txt_tim_kiem.TabIndex = 2900;
            // 
            // m_lbl_doanh_thu
            // 
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(165, 145);
            this.m_lbl_doanh_thu.Name = "m_lbl_doanh_thu";
            this.m_lbl_doanh_thu.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_doanh_thu.TabIndex = 2914;
            ...
            this.label4.TabIndex = 2915;
            this.label4.Text = "Báo cáo doanh thu theo bác sỹ";
            // 
            // f441_bcdt_bac_sy_de
            // 
            ...
            this.Name = "f441_bcdt_bac_sy_de";
            this.Text = "F441-Báo cáo doanh thu theo bác sỹ";
            this.Load += new System.EventHandler(this.f441_bcdt_bac_sy_de_Load);
...
,TEN_BAC_SY = 1
        ...
        private const String m_str_tim_kiem = "Nhập tên bác sỹ, mã giao dịch, mã khách hàng, tên khách hàng cần tìm";
        DateTime v_dat_ngay_bd;
        DateTime v_dat_ngay_kt;
		BKI_QLHT.DS.V_BC_DOANH_THU_BAC_SY_DE m_v_ds = new BKI_QLHT.DS.V_BC_DOANH_THU_BAC_SY_DE();
		US_V_BC_DOANH_THU_BAC_SY_DE m_v_us = new US_V_BC_DOANH_THU_BAC_SY_DE();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_DOANH_THU_BAC_SY_DE"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds._V_BC_DOANH_THU_BAC_SY_DE)
            {
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_BAC_SY_DE.TEN_BAC_SY].ToString());
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_BAC_SY_DE.TEN_KHACH_HANG].ToString());

                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_BAC_SY_DE.MA_KHACH_HANG].ToString());
            }
        ...
        private void format_controls()
        {
            ...
            m_fg.Cols[(int)e_col_Number.TEN_BAC_SY].Visible = false;
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_BAC_SY_DE.MA_GIAO_DICH, e_col_Number.MA_GIAO_DICH);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_BAC_SY_DE.MA_KHACH_HANG, e_col_Number.MA_KHACH_HANG);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_BAC_SY_DE.TEN_KHACH_HANG, e_col_Number.TEN_KHACH_HANG);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_BAC_SY_DE.DOANH_THU, e_col_Number.DOANH_THU);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_BAC_SY_DE.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_BAC_SY_DE.TEN_BAC_SY, e_col_Number.TEN_BAC_SY);

            ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg, v_htb, m_v_ds._V_BC_DOANH_THU_BAC_SY_DE.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds._V_BC_DOANH_THU_BAC_SY_DE.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][BKI_QLHT.DS.CDBNames
                .V_BC_DOANH_THU_BAC_SY.DOANH_THU]);
            }
            ...
            m_fg.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Count // chỗ này dùng hàm count tức là để đếm, có thể dùng các hàm khác thay thế
              , 0
              , (int)e_col_Number.TEN_BAC_SY // chỗ này là tên trường mà mình nhóm
            ...
            m_lbl_count.Text = m_v_ds._V_BC_DOANH_THU_BAC_SY_DE.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_DOANH_THU_BAC_SY_DE i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_DOANH_THU_BAC_SY_DE i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f442_bao_cao_doanh_thu_chi_tiet_theo_bac_sy.xlsx", 10, 1);
            //người làm báo cáo
        ...
        private void set_define_events()
        {
            ...
            this.KeyDown += new KeyEventHandler(f441_bcdt_bac_sy_de_KeyDown);
        }
...
//
		...
		//
		//
		private void f441_bcdt_bac_sy_de_Load(object sender, System.EventArgs e) {
			try{
        ...
        private void f441_bcdt_bac_sy_de_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
