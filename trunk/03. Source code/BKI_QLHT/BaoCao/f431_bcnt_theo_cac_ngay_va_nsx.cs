///************************************************
/// Generated by: TuNA
/// Date: 20-05-2014 12:15:04
/// Goal: Create Form for V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f431_bcnt_theo_cac_ngay_va_nsx : System.Windows.Forms.Form
	{
		...
		public f431_bcnt_theo_cac_ngay_va_nsx()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f431_bcnt_theo_cac_ngay_va_nsx));
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(694, 242);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(184, 105);
            this.m_lbl_doanh_thu.Name = "m_lbl_doanh_thu";
            this.m_lbl_doanh_thu.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_doanh_thu.TabIndex = 2947;
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(184, 83);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 2945;
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(428, 45);
            ...
            this.m_dat_den_ngay.TabIndex = 2942;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(558, 10);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 2938;
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(169, 15);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(365, 20);
            this.m_txt_tim_kiem.TabIndex = 2937;
            // 
            // f431_bcnt_theo_cac_ngay_va_nsx
            // 
            ...
            this.Name = "f431_bcnt_theo_cac_ngay_va_nsx";
            this.Text = "f431_bcnt_theo_cac_ngay_va_nsx";
            this.Load += new System.EventHandler(this.f431_bcnt_theo_cac_ngay_va_nsx_Load);
...
,DON_VI_TINH = 4
        ...
        private const String m_str_tim_kiem = "Nhập tên nước sản xuất cần tìm";
        DateTime v_dat_ngay_bd;
        DateTime v_dat_ngay_kt;
		DS_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX m_v_ds = new DS_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX();
		US_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX m_v_us = new US_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX)
            {
                v_acsc_search.Add(dr[V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX.TEN_NSX].ToString());
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX.TEN_NSX, e_col_Number.TEN_NSX);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX.THANH_TIEN, e_col_Number.THANH_TIEN);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX.TONG_SO_LUONG_NHAP, e_col_Number.TONG_SO_LUONG_NHAP);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX.DON_VI_TINH, e_col_Number.DON_VI_TINH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX.NewRow());
			return v_obj_trans;			
		}
        private void load_data_2_grid()
        {
            ...
            for (int i = 0; i < m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX.THANH_TIEN]);
            }
            ...
            m_lbl_count.Text = m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NSX i_us
			, int i_grid_row) {
...
//
		...
		//
		//
		private void f431_bcnt_theo_cac_ngay_va_nsx_Load(object sender, System.EventArgs e) {
			try{
