///************************************************
/// Generated by: TuNA
/// Date: 24-05-2014 01:28:57
/// Goal: Create Form for V_BC_NHAP_THUOC_NGAY_N_HSX
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f451_bcnt_ngay_va_hsx : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f451_bcnt_ngay_va_hsx));
            ...
            this.m_cmd_xuat_excel.TabIndex = 47;
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(686, 212);
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(172, 109);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 3041;
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(451, 72);
            ...
            this.m_dat_den_ngay.TabIndex = 3038;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(577, 36);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 3034;
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(156, 41);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(401, 20);
            this.m_txt_tim_kiem.TabIndex = 3033;
            // 
            // m_lbl_doanh_thu
            // 
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(172, 131);
            this.m_lbl_doanh_thu.Name = "m_lbl_doanh_thu";
            this.m_lbl_doanh_thu.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_doanh_thu.TabIndex = 3047;
            ...
            this.label4.Text = "Báo cáo nhập thuốc theo ngày và hãng sản xuất";
            // 
            // f451_bcnt_ngay_va_hsx
            // 
            ...
            this.Name = "f451_bcnt_ngay_va_hsx";
            this.Text = "F451-Báo cáo nhập thuốc theo ngày và hãng sản xuất";
            this.Load += new System.EventHandler(this.f451_bcnt_ngay_va_hsx_Load);
...
,NGAY_GIAO_DICH = 1
        ...
        BKI_QLHT.DS.V_BC_NHAP_THUOC_NGAY_N_HSX m_v_ds = new BKI_QLHT.DS.V_BC_NHAP_THUOC_NGAY_N_HSX();
		US_V_BC_NHAP_THUOC_NGAY_N_HSX m_v_us = new US_V_BC_NHAP_THUOC_NGAY_N_HSX();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_NHAP_THUOC_NGAY_N_HSX"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds._V_BC_NHAP_THUOC_NGAY_N_HSX)
            {
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NGAY_N_HSX.MA_GIAO_DICH].ToString());
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NGAY_N_HSX.TEN_HSX].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
            ...
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NGAY_N_HSX.THANH_TIEN, e_col_Number.THANH_TIEN);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NGAY_N_HSX.TEN_HSX, e_col_Number.TEN_HSX);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NGAY_N_HSX.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds._V_BC_NHAP_THUOC_NGAY_N_HSX.NewRow());
			return v_obj_trans;			
		}
        private void load_data_2_grid()
        {
            ...
            for (int i = 0; i < m_v_ds._V_BC_NHAP_THUOC_NGAY_N_HSX.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][BKI_QLHT.DS.CDBNames
                .V_BC_NHAP_THUOC_NGAY_N_HSX.THANH_TIEN]);
            }
            ...
            m_fg.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Count // chỗ này dùng hàm count tức là để đếm, có thể dùng các hàm khác thay thế
              ...
              , (int)e_col_Number.TEN_HSX // chỗ này là tên trường mà mình Count
              , "{0}"
              );
            ...
            m_lbl_count.Text = m_v_ds._V_BC_NHAP_THUOC_NGAY_N_HSX.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_NHAP_THUOC_NGAY_N_HSX i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_NHAP_THUOC_NGAY_N_HSX i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f451_bao_cao_nhap_thuoc_theo_ngay_va_hang_san_xuat.xlsx", 10, 1);
            //người làm báo cáo
        ...
        private void set_define_events()
        {
            ...
            this.KeyDown += new KeyEventHandler(f451_bcnt_ngay_va_hsx_KeyDown);
        }

       private void f451_bcnt_ngay_va_hsx_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
...
//
		...
		//
		//
		private void f451_bcnt_ngay_va_hsx_Load(object sender, System.EventArgs e) {
			try{
