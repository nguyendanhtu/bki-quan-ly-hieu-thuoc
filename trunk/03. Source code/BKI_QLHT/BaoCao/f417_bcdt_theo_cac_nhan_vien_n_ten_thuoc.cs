///************************************************
/// Generated by: TuNA
/// Date: 15-05-2014 01:16:47
/// Goal: Create Form for V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_N_TEN_THUOC
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f417_bcdt_theo_cac_nhan_vien_n_ten_thuoc : System.Windows.Forms.Form
	{
		...
		public f417_bcdt_theo_cac_nhan_vien_n_ten_thuoc()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f417_bcdt_theo_cac_nhan_vien_n_ten_thuoc));
            ...
            this.m_pnl_out_place_dm.Size = new System.Drawing.Size(917, 36);
            ...
            this.m_cmd_exit.Location = new System.Drawing.Point(825, 4);
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(917, 248);
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(579, 43);
            ...
            this.m_dat_den_ngay.TabIndex = 2860;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(705, 7);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 2856;
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(225, 104);
            this.m_lbl_doanh_thu.Name = "m_lbl_doanh_thu";
            this.m_lbl_doanh_thu.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_doanh_thu.TabIndex = 2850;
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(225, 82);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 2848;
            ...
            this.m_cmd_xuat_excel.TabIndex = 34;
            this.m_cmd_xuat_excel.Text = "Xuất ra Excel";
            // 
            // f417_bcdt_theo_cac_nhan_vien_n_ten_thuoc
            // 
            ...
            this.Name = "f417_bcdt_theo_cac_nhan_vien_n_ten_thuoc";
            this.Text = "f417_bcdt_theo_cac_nhan_vien_n_ten_thuoc";
            this.Load += new System.EventHandler(this.f417_bcdt_theo_cac_nhan_vien_n_ten_thuoc_Load);
...
,TONG_SO_LUONG_BAN = 4
        ...
        private const String m_str_tim_kiem = "Nhập tên nhân viên, tên thuốc cần tìm";
        DateTime v_dat_ngay_bd;
        DateTime v_dat_ngay_kt;
		DS_V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_n_TEN_THUOC m_v_ds = new DS_V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_n_TEN_THUOC();
		US_V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_N_TEN_THUOC m_v_us = new US_V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_N_TEN_THUOC();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_N_TEN_THUOC"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_n_TEN_THUOC)
            {
                v_acsc_search.Add(dr[V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_n_TEN_THUOC.TEN_NHAN_VIEN].ToString());
                v_acsc_search.Add(dr[V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_n_TEN_THUOC.TEN_THUOC].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_n_TEN_THUOC.TEN_NHAN_VIEN, e_col_Number.TEN_NHAN_VIEN);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_n_TEN_THUOC.DON_VI_TINH, e_col_Number.DON_VI_TINH);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_n_TEN_THUOC.DOANH_THU, e_col_Number.DOANH_THU);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_n_TEN_THUOC.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_n_TEN_THUOC.TEN_THUOC, e_col_Number.TEN_THUOC);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_n_TEN_THUOC.TONG_SO_LUONG_BAN, e_col_Number.TONG_SO_LUONG_BAN);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_n_TEN_THUOC.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds.V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_n_TEN_THUOC.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_n_TEN_THUOC.DOANH_THU]);
            }
            ...
            m_fg.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Count // chỗ này dùng hàm count tức là để đếm, có thể dùng các hàm khác thay thế
              , 0
              , (int)e_col_Number.TEN_NHAN_VIEN // chỗ này là tên trường mà mình nhóm
            ...
            m_lbl_count.Text = m_v_ds.V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_n_TEN_THUOC.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_N_TEN_THUOC i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_N_TEN_THUOC i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f417_bao_cao_doanh_thu_theo_cac_nhan_vien_va_ten_thuoc.xlsx", 10, 1);
            //người làm báo cáo
...
//
		...
		//
		//
		private void f417_bcdt_theo_cac_nhan_vien_n_ten_thuoc_Load(object sender, System.EventArgs e) {
			try{
