///************************************************
/// Generated by: TuNA
/// Date: 15-05-2014 12:27:15
/// Goal: Create Form for V_BC_DOANH_THU_THEO_CAC_NGAY_N_NHAN_VIEN
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f407_bcdt_theo_ngay_n_nhan_vien : System.Windows.Forms.Form
	{
		...
		public f407_bcdt_theo_ngay_n_nhan_vien()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f407_bcdt_theo_ngay_n_nhan_vien));
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(764, 248);
            ...
            this.m_lbl_nguoi_lam_bc.Location = new System.Drawing.Point(617, 82);
            ...
            this.m_lbl_ngay_lam_bc.Location = new System.Drawing.Point(617, 104);
            ...
            this.m_lbl_nguoi_lam_bao_cao.Location = new System.Drawing.Point(500, 82);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(191, 104);
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(191, 82);
            ...
            // 
            // f407_bcdt_theo_ngay_n_nhan_vien
            // 
            ...
            this.Name = "f407_bcdt_theo_ngay_n_nhan_vien";
            this.Text = "f407_bcdt_theo_ngay_n_nhan_vien";
            this.Load += new System.EventHandler(this.f407_bcdt_theo_ngay_n_nhan_vien_Load);
...
,DON_VI_TINH = 4
		...
		DS_V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHAN_VIEN m_v_ds = new DS_V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHAN_VIEN();
		US_V_BC_DOANH_THU_THEO_CAC_NGAY_N_NHAN_VIEN m_v_us = new US_V_BC_DOANH_THU_THEO_CAC_NGAY_N_NHAN_VIEN();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_DOANH_THU_THEO_CAC_NGAY_N_NHAN_VIEN"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHAN_VIEN)
            {
                v_acsc_search.Add(dr[V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHAN_VIEN.TEN_NHAN_VIEN].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHAN_VIEN.TEN_NHAN_VIEN, e_col_Number.TEN_NHAN_VIEN);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHAN_VIEN.DOANH_THU, e_col_Number.DOANH_THU);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHAN_VIEN.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHAN_VIEN.TONG_SO_LUONG_BAN, e_col_Number.TONG_SO_LUONG_BAN);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHAN_VIEN.DON_VI_TINH, e_col_Number.DON_VI_TINH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHAN_VIEN.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds.V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHAN_VIEN.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHAN_VIEN.DOANH_THU]);
            }
            ...
            m_lbl_count.Text = m_v_ds.V_BC_DOANH_THU_THEO_CAC_NGAY_n_NHAN_VIEN.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_DOANH_THU_THEO_CAC_NGAY_N_NHAN_VIEN i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_DOANH_THU_THEO_CAC_NGAY_N_NHAN_VIEN i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f407_bao_cao_doanh_thu_theo_cac_ngay_va_nhan_vien.xlsx", 10, 1);
            //người làm báo cáo
...
//
		...
		//
		//
		private void f407_bcdt_theo_ngay_n_nhan_vien_Load(object sender, System.EventArgs e) {
			try{
                set_initial_form_load(); set_initial_form_load();
                load_data_2_lbl();
