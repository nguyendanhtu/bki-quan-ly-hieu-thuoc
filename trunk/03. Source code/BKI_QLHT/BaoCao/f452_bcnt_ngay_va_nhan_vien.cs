///************************************************
/// Generated by: TuNA
/// Date: 24-05-2014 01:39:29
/// Goal: Create Form for V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f452_bcnt_ngay_va_nhan_vien : System.Windows.Forms.Form
	{
		...
		public f452_bcnt_ngay_va_nhan_vien()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f452_bcnt_ngay_va_nhan_vien));
            ...
            this.m_cmd_xuat_excel.TabIndex = 48;
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(686, 210);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(164, 132);
            this.m_lbl_doanh_thu.Name = "m_lbl_doanh_thu";
            this.m_lbl_doanh_thu.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_doanh_thu.TabIndex = 3062;
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(164, 110);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 3056;
            ...
            this.label1.TabIndex = 3055;
            this.label1.Text = "Số kết quả trong báo cáo";
            // 
            // label7
            // 
            this.label7.AutoSize = true;
            this.label7.Location = new System.Drawing.Point(373, 79);
            this.label7.Name = "label7";
            this.label7.Size = new System.Drawing.Size(53, 13);
            this.label7.TabIndex = 3054;
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(443, 73);
            ...
            this.m_dat_den_ngay.TabIndex = 3053;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(569, 37);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 3049;
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(148, 42);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(401, 20);
            this.m_txt_tim_kiem.TabIndex = 3048;
            // 
            // label4
            // 
            ...
            this.label4.TabIndex = 3063;
            this.label4.Text = "Báo cáo nhập thuốc theo ngày và nhân viên";
            // 
            // f452_bcnt_ngay_va_nhan_vien
            // 
            ...
            this.Name = "f452_bcnt_ngay_va_nhan_vien";
            this.Text = "F452-Báo cáo nhập thuốc theo ngày và nhân viên";
            this.Load += new System.EventHandler(this.f452_bcnt_ngay_va_nhan_vien_Load);
...
,TEN_NHAN_VIEN = 3
        ...
        private const String m_str_tim_kiem = "Nhập tên nhân viên, mã giao dịch cần tìm";
        DateTime v_dat_ngay_bd;
        DateTime v_dat_ngay_kt;
        BKI_QLHT.DS.V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN m_v_ds = new BKI_QLHT.DS.V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN();
		US_V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN m_v_us = new US_V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds._V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN)
            {
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN.MA_GIAO_DICH].ToString());
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN.TEN_NHAN_VIEN].ToString());
            }
        ...
        private void format_controls()
        {
            ...
            //m_fg.Cols[(int)e_col_Number.MA_GIAO_DICH].Visible = false;
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
            ...
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN.MA_GIAO_DICH, e_col_Number.MA_GIAO_DICH);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN.THANH_TIEN, e_col_Number.THANH_TIEN);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN.TEN_NHAN_VIEN, e_col_Number.TEN_NHAN_VIEN);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds._V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds._V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][BKI_QLHT.DS.CDBNames
                .V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN.THANH_TIEN]);
            }
            ...
            m_lbl_count.Text = m_v_ds._V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f452_bao_cao_nhap_thuoc_theo_ngay_va_nhan_vien.xlsx", 10, 1);
            //người làm báo cáo
        ...
        private void set_define_events()
        {
            ...
            this.KeyDown += new KeyEventHandler(f452_bcnt_ngay_va_nhan_vien_KeyDown);
        }

       private void f452_bcnt_ngay_va_nhan_vien_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
...
//
		...
		//
		//
		private void f452_bcnt_ngay_va_nhan_vien_Load(object sender, System.EventArgs e) {
			try{
