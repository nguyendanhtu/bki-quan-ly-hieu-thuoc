///************************************************
/// Generated by: TuNA
/// Date: 18-05-2014 07:19:55
/// Goal: Create Form for V_BC_NHAP_THUOC_THEO_CAC_HSX_DE
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f425_bcnt_theo_cac_HSX_de : System.Windows.Forms.Form
	{
		...
		public f425_bcnt_theo_cac_HSX_de()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f425_bcnt_theo_cac_HSX_de));
            ...
            this.m_pnl_control.Size = new System.Drawing.Size(850, 36);
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(850, 202);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(196, 146);
            this.m_lbl_doanh_thu.Name = "m_lbl_doanh_thu";
            this.m_lbl_doanh_thu.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_doanh_thu.TabIndex = 2887;
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(196, 124);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 2885;
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(508, 76);
            ...
            this.m_dat_den_ngay.TabIndex = 2882;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(634, 40);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 2878;
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(213, 45);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(401, 20);
            this.m_txt_tim_kiem.TabIndex = 2877;
            // 
            // label4
            // 
            ...
            this.label4.TabIndex = 2892;
            this.label4.Text = "Báo cáo nhập thuốc theo hãng sản xuất";
            // 
            // f425_bcnt_theo_cac_HSX_de
            // 
            ...
            this.Name = "f425_bcnt_theo_cac_HSX_de";
            this.Text = "F425-Báo cáo nhập thuốc theo hãng sản xuất";
            this.Load += new System.EventHandler(this.f425_bcnt_theo_cac_HSX_de_Load);
...
,DON_VI_TINH = 5
        ...
        private const String m_str_tim_kiem = "Nhập tên thuốc, tên hãng sản xuất cần tìm";
        DateTime v_dat_ngay_bd;
        DateTime v_dat_ngay_kt;
		DS_V_BC_NHAP_THUOC_THEO_CAC_HSX_de m_v_ds = new DS_V_BC_NHAP_THUOC_THEO_CAC_HSX_de();
		US_V_BC_NHAP_THUOC_THEO_CAC_HSX_DE m_v_us = new US_V_BC_NHAP_THUOC_THEO_CAC_HSX_DE();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_NHAP_THUOC_THEO_CAC_HSX_DE"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_HSX_de)
            {
                v_acsc_search.Add(dr[V_BC_NHAP_THUOC_THEO_CAC_HSX_de.TEN_HSX].ToString());
                v_acsc_search.Add(dr[V_BC_NHAP_THUOC_THEO_CAC_HSX_de.TEN_THUOC].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_HSX_de.THANH_TIEN, e_col_Number.THANH_TIEN);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_HSX_de.TONG_SO_LUONG_NHAP, e_col_Number.TONG_SO_LUONG_NHAP);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_HSX_de.TEN_HSX, e_col_Number.TEN_HSX);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_HSX_de.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_HSX_de.TEN_THUOC, e_col_Number.TEN_THUOC);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_HSX_de.DON_VI_TINH, e_col_Number.DON_VI_TINH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_HSX_de.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_HSX_de.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_NHAP_THUOC_THEO_CAC_HSX_de.THANH_TIEN]);
            }
		...
		private void grid2us_object(US_V_BC_NHAP_THUOC_THEO_CAC_HSX_DE i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_NHAP_THUOC_THEO_CAC_HSX_DE i_us
			, int i_grid_row) {
...
//
		...
		//
		//
		private void f425_bcnt_theo_cac_HSX_de_Load(object sender, System.EventArgs e) {
			try{
