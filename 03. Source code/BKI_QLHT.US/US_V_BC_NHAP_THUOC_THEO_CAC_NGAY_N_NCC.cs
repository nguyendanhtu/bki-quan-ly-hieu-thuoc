///************************************************
/// Generated by: TuNA
/// Date: 17-05-2014 11:14:25
/// Goal: Create User Service Class for V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC
///************************************************
/// <summary>
/// Create User Service Class for V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC
/// </summary>
...
public class US_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC : US_Object
{
	private const string c_TableName = "V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC";
...
#region "Init Functions"
    public void FillDatasetSearch(DS_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC op_ds_bc_da, string i_str_tu_khoa, DateTime i_dat_ngay_bd, DateTime i_dat_ngay_kt)
    {
        CStoredProc v_sp = new CStoredProc("pr_V_BC_NHAP_THUOC_CAC_NGAY_N_NCC_search");
	...
	public US_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC() 
	{
		pm_objDS = new DS_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC(decimal i_dbID) 
	{
		pm_objDS = new DS_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_NCC();
		pm_strTableName = c_TableName;
