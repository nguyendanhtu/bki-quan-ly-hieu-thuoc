///************************************************
/// Generated by: VinhNQ
/// Date: 03/05/2014 03:59:02
/// Goal: Create User Service Class for V_DM_HANG_SX
///************************************************
/// <summary>
/// Create User Service Class for V_DM_HANG_SX
/// </summary>
...
public class US_V_DM_HANG_SX : US_Object
{
	private const string c_TableName = "V_DM_HANG_SX";
...
#region "Init Functions"
	public US_V_DM_HANG_SX() 
	{
		pm_objDS = new DS_V_DM_HANG_SX();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_DM_HANG_SX(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_DM_HANG_SX(decimal i_dbID) 
	{
		pm_objDS = new DS_V_DM_HANG_SX();
		pm_strTableName = c_TableName;
    ...
    public void FillDatasetSearchByMaNSX(DS.DS_V_DM_HANG_SX ip_v_ds_dm_hang_sx, string ip_str)
    {
        CStoredProc v_stored_proc = new CStoredProc("pr_DM_NHA_SX_by_ma_nha_sx");
        v_stored_proc.addNVarcharInputParam("@TU_KHOA", ip_str);
        v_stored_proc.fillDataSetByCommand(this, ip_v_ds_dm_hang_sx);
    }
}
}
