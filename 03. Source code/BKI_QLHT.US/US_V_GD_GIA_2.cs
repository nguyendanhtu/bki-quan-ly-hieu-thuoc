...
#region "Init Functions"
    ...
    public void FillDatasetSearch(DS_V_GD_GIA_2 ip_ds_v_gd_gia, string ip_str_tu_khoa)
    {
        ...
        v_sp.addNVarcharInputParam("@TU_KHOA",ip_str_tu_khoa);
        v_sp.fillDataSetByCommand(this,ip_ds_v_gd_gia);
    }

    public void FillDatasetByTime(DS_V_GD_GIA_2 m_ds)
    {
        CStoredProc v_stored_proc = new CStoredProc("pr_V_GD_GIA_2_load_by_time");
