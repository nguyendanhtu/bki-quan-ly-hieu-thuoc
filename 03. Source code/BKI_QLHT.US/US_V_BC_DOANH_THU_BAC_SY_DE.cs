///************************************************
/// Generated by: TuNA
/// Date: 23-05-2014 10:06:49
/// Goal: Create User Service Class for V_BC_DOANH_THU_BAC_SY_DE
///************************************************
/// <summary>
/// Create User Service Class for V_BC_DOANH_THU_BAC_SY_DE
/// </summary>
using System;
using BKI_QLHT;
...
public class US_V_BC_DOANH_THU_BAC_SY_DE : US_Object
{
	private const string c_TableName = "V_BC_DOANH_THU_BAC_SY_DE";
...
#region "Init Functions"
    public void FillDatasetSearch(BKI_QLHT.DS.V_BC_DOANH_THU_BAC_SY_DE op_ds_bc_da, string i_str_tu_khoa, DateTime i_dat_ngay_bd, DateTime i_dat_ngay_kt)
    {
        CStoredProc v_sp = new CStoredProc("pr_V_BC_DOANH_THU_BAC_SY_DE_search");
	...
	public US_V_BC_DOANH_THU_BAC_SY_DE() 
	{
		pm_objDS = new BKI_QLHT.DS.V_BC_DOANH_THU_BAC_SY_DE();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_BC_DOANH_THU_BAC_SY_DE(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_BC_DOANH_THU_BAC_SY_DE(decimal i_dbID) 
	{
		pm_objDS = new BKI_QLHT.DS.V_BC_DOANH_THU_BAC_SY_DE();
		pm_strTableName = c_TableName;
