///************************************************
/// Generated by: TuNA
/// Date: 23-05-2014 03:31:50
/// Goal: Create User Service Class for V_BC_DOANH_THU_NCC
///************************************************
/// <summary>
/// Create User Service Class for V_BC_DOANH_THU_NCC
/// </summary>
...
public class US_V_BC_DOANH_THU_NCC : US_Object
{
	private const string c_TableName = "V_BC_DOANH_THU_NCC";
...
#region "Init Functions"
    public void FillDatasetSearch(BKI_QLHT.DS.V_BC_DOANH_THU_NCC op_ds_bc_da, string i_str_tu_khoa, DateTime i_dat_ngay_bd, DateTime i_dat_ngay_kt)
    {
        CStoredProc v_sp = new CStoredProc("pr_V_BC_DOANH_THU_NCC_search");
	...
	public US_V_BC_DOANH_THU_NCC() 
	{
		pm_objDS = new BKI_QLHT.DS.V_BC_DOANH_THU_NCC();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_BC_DOANH_THU_NCC(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_BC_DOANH_THU_NCC(decimal i_dbID) 
	{
		pm_objDS = new BKI_QLHT.DS.V_BC_DOANH_THU_NCC();
		pm_strTableName = c_TableName;
