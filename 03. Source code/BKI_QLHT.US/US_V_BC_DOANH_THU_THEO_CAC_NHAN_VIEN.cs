///************************************************
/// Generated by: TuNA
/// Date: 15-05-2014 01:14:24
/// Goal: Create User Service Class for V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN
///************************************************
/// <summary>
/// Create User Service Class for V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN
/// </summary>
...
public class US_V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN : US_Object
{
	private const string c_TableName = "V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN";
...
#region "Init Functions"
    public void FillDatasetSearch(DS_V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN op_ds_bc_da, string i_str_tu_khoa, DateTime i_dat_ngay_bd, DateTime i_dat_ngay_kt)
    {
        CStoredProc v_sp = new CStoredProc("pr_V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN_search");
	...
	public US_V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN() 
	{
		pm_objDS = new DS_V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN(decimal i_dbID) 
	{
		pm_objDS = new DS_V_BC_DOANH_THU_THEO_CAC_NHAN_VIEN();
		pm_strTableName = c_TableName;
