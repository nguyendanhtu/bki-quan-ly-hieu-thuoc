///************************************************
/// Generated by: TuNA
/// Date: 19-05-2014 02:31:37
/// Goal: Create Form for V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f429_bcnt_cac_ngay_va_HSX : System.Windows.Forms.Form
	{
		...
		public f429_bcnt_cac_ngay_va_HSX()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f429_bcnt_cac_ngay_va_HSX));
            ...
            this.m_pnl_out_place_dm.Size = new System.Drawing.Size(722, 36);
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(722, 235);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(177, 113);
            this.m_lbl_doanh_thu.Name = "m_lbl_doanh_thu";
            this.m_lbl_doanh_thu.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_doanh_thu.TabIndex = 2932;
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(177, 91);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 2930;
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(421, 53);
            ...
            this.m_dat_den_ngay.TabIndex = 2927;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(551, 18);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 2923;
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(162, 23);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(365, 20);
            this.m_txt_tim_kiem.TabIndex = 2922;
            // 
            // m_cmd_xuat_excel
            // 
            ...
            this.Name = "f429_bcnt_cac_ngay_va_HSX";
            this.Text = "f429_bcnt_cac_ngay_va_HSX";
            this.Load += new System.EventHandler(this.f429_bcnt_cac_ngay_va_HSX_Load);
...
,DON_VI_TINH = 4
        ...
        private const String m_str_tim_kiem = "Nhập tên hãng sản xuất cần tìm";
        DateTime v_dat_ngay_bd;
        DateTime v_dat_ngay_kt;
		DS_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX m_v_ds = new DS_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX();
		US_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX m_v_us = new US_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX)
            {
                v_acsc_search.Add(dr[V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX.TEN_HSX].ToString());
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX.THANH_TIEN, e_col_Number.THANH_TIEN);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX.TEN_HSX, e_col_Number.TEN_HSX);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX.TONG_SO_LUONG_NHAP, e_col_Number.TONG_SO_LUONG_NHAP);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX.DON_VI_TINH, e_col_Number.DON_VI_TINH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX.THANH_TIEN]);
            }
            ...
            m_lbl_count.Text = m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_NHAP_THUOC_THEO_CAC_NGAY_N_HSX i_us
			, int i_grid_row) {
...
//
		...
		//
		//
		private void f429_bcnt_cac_ngay_va_HSX_Load(object sender, System.EventArgs e) {
			try{
