///************************************************
/// Generated by: TuNA
/// Date: 18-05-2014 03:12:13
/// Goal: Create Form for V_BC_NHAP_THUOC_THEO_CAC_HSX
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f424_bcnt_theo_cac_hsx : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f424_bcnt_theo_cac_hsx));
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(784, 243);
            ...
            this.m_lbl_nguoi_lam_bc.Location = new System.Drawing.Point(698, 80);
            ...
            this.m_lbl_ngay_lam_bc.Location = new System.Drawing.Point(698, 102);
            ...
            this.m_lbl_nguoi_lam_bao_cao.Location = new System.Drawing.Point(581, 80);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(191, 102);
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(191, 80);
            ...
            this.label7.Location = new System.Drawing.Point(401, 49);
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(471, 43);
            ...
            this.m_dat_tu_ngay.Location = new System.Drawing.Point(176, 43);
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(597, 7);
            ...
            this.Name = "f424_bcnt_theo_cac_hsx";
            this.Text = "f424_bcnt_theo_cac_hsx";
            this.Load += new System.EventHandler(this.f424_bcnt_theo_cac_hsx_Load);
...
,DON_VI_TINH = 4
		...
		DS_V_BC_NHAP_THUOC_THEO_CAC_HSX m_v_ds = new DS_V_BC_NHAP_THUOC_THEO_CAC_HSX();
		US_V_BC_NHAP_THUOC_THEO_CAC_HSX m_v_us = new US_V_BC_NHAP_THUOC_THEO_CAC_HSX();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_NHAP_THUOC_THEO_CAC_HSX"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_HSX)
            {
                v_acsc_search.Add(dr[V_BC_NHAP_THUOC_THEO_CAC_HSX.TEN_HSX].ToString());
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_HSX.THANH_TIEN, e_col_Number.THANH_TIEN);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_HSX.TEN_HSX, e_col_Number.TEN_HSX);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_HSX.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_HSX.TONG_SO_LUONG_NHAP, e_col_Number.TONG_SO_LUONG_NHAP);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_HSX.DON_VI_TINH, e_col_Number.DON_VI_TINH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_HSX.NewRow());
			return v_obj_trans;			
		}
            ...
            for (int i = 0; i < m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_HSX.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_NHAP_THUOC_THEO_CAC_HSX.THANH_TIEN]);
            }
            ...
            m_lbl_count.Text = m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_HSX.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_NHAP_THUOC_THEO_CAC_HSX i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_NHAP_THUOC_THEO_CAC_HSX i_us
			, int i_grid_row) {
...
//
		...
		//
		//
		private void f424_bcnt_theo_cac_hsx_Load(object sender, System.EventArgs e) {
			try{
