///************************************************
/// Generated by: TuNA
/// Date: 15-05-2014 01:17:47
/// Goal: Create Form for V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f418_bcdt_theo_cac_nhom_khach_hang : System.Windows.Forms.Form
	{
		...
		public f418_bcdt_theo_cac_nhom_khach_hang()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f418_bcdt_theo_cac_nhom_khach_hang));
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(787, 247);
            ...
            this.label7.Location = new System.Drawing.Point(420, 55);
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(490, 49);
            ...
            this.m_dat_tu_ngay.Location = new System.Drawing.Point(195, 49);
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(616, 13);
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(195, 18);
            ...
            this.m_lbl_nguoi_lam_bc.Location = new System.Drawing.Point(636, 88);
            ...
            this.m_lbl_ngay_lam_bc.Location = new System.Drawing.Point(636, 110);
            ...
            this.m_lbl_nguoi_lam_bao_cao.Location = new System.Drawing.Point(519, 88);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(210, 110);
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(210, 88);
            ...
            // 
            // f418_bcdt_theo_cac_nhom_khach_hang
            // 
            ...
            this.Name = "f418_bcdt_theo_cac_nhom_khach_hang";
            this.Text = "f418_bcdt_theo_cac_nhom_khach_hang";
            this.Load += new System.EventHandler(this.f418_bcdt_theo_cac_nhom_khach_hang_Load);
...
,DON_VI_TINH = 4
        ...
        DS_V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG m_v_ds = new DS_V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG();
		US_V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG m_v_us = new US_V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG)
            {
                v_acsc_search.Add(dr[V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG.TEN_NHOM_KH].ToString());
            }
        ...
        private void format_controls()
        {
            ...
            m_fg.Cols[(int)e_col_Number.TEN_NHOM_KH].Visible = false;
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG.DOANH_THU, e_col_Number.DOANH_THU);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG.TEN_NHOM_KH, e_col_Number.TEN_NHOM_KH);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG.TONG_SO_LUONG_BAN, e_col_Number.TONG_SO_LUONG_BAN);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG.DON_VI_TINH, e_col_Number.DON_VI_TINH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds.V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG.Count; i++)
            {
            ...
            m_fg.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Count // chỗ này dùng hàm count tức là để đếm, có thể dùng các hàm khác thay thế
              , 0
              , (int)e_col_Number.TEN_NHOM_KH // chỗ này là tên trường mà mình nhóm
              , (int)e_col_Number.DON_VI_TINH // chỗ này là tên trường mà mình Count
              , "{0}"
              );
            m_fg.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum
                , 0
                , (int)e_col_Number.TEN_NHOM_KH
                , (int)e_col_Number.DOANH_THU
                , "{0}"
                );
            m_lbl_count.Text = m_v_ds.V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_DOANH_THU_THEO_CAC_NHOM_KHACH_HANG i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f418_bao_cao_doanh_thu_theo_cac_nhom_khach_hang.xlsx", 10, 1);
            //người làm báo cáo
...
//
		...
		//
		//
		private void f418_bcdt_theo_cac_nhom_khach_hang_Load(object sender, System.EventArgs e) {
			try{
