///************************************************
/// Generated by: TuNA
/// Date: 23-05-2014 10:34:47
/// Goal: Create Form for V_BC_DOANH_THU_NV
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f447_bcdt_nhan_vien : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f447_bcdt_nhan_vien));
            ...
            this.m_cmd_xuat_excel.TabIndex = 44;
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(171, 137);
            this.m_lbl_doanh_thu.Name = "m_lbl_doanh_thu";
            this.m_lbl_doanh_thu.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_doanh_thu.TabIndex = 3004;
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(171, 115);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 2998;
            ...
            this.label1.TabIndex = 2997;
            this.label1.Text = "Số kết quả trong báo cáo";
            // 
            // label7
            // 
            this.label7.AutoSize = true;
            this.label7.Location = new System.Drawing.Point(380, 84);
            this.label7.Name = "label7";
            this.label7.Size = new System.Drawing.Size(53, 13);
            this.label7.TabIndex = 2996;
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(450, 78);
            ...
            this.m_dat_den_ngay.TabIndex = 2995;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(576, 42);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 2991;
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(155, 47);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(401, 20);
            this.m_txt_tim_kiem.TabIndex = 2990;
            // 
            // label4
            // 
            ...
            this.label4.TabIndex = 3005;
            this.label4.Text = "Báo cáo doanh thu theo nhân viên";
            // 
            // f447_bcdt_nhan_vien
            // 
            ...
            this.Name = "f447_bcdt_nhan_vien";
            this.Text = "F447-Báo cáo doanh thu theo nhân viên";
            this.Load += new System.EventHandler(this.f447_bcdt_nhan_vien_Load);
...
,NGAY_GIAO_DICH = 2
        ...
        BKI_QLHT.DS.V_BC_DOANH_THU_NV m_v_ds = new BKI_QLHT.DS.V_BC_DOANH_THU_NV();
		US_V_BC_DOANH_THU_NV m_v_us = new US_V_BC_DOANH_THU_NV();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_DOANH_THU_NV"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds._V_BC_DOANH_THU_NV)
            {
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_NV.TEN_NHAN_VIEN].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
            ...
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_NV.TEN_NHAN_VIEN, e_col_Number.TEN_NHAN_VIEN);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_NV.DOANH_THU, e_col_Number.DOANH_THU);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_NV.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds._V_BC_DOANH_THU_NV.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            m_lbl_count.Text = m_v_ds._V_BC_DOANH_THU_NV.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_DOANH_THU_NV i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_DOANH_THU_NV i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f447_bao_cao_doanh_thu_theo_nhan_vien.xlsx", 10, 1);
            //người làm báo cáo
        ...
        private void set_define_events()
        {
            ...
            this.KeyDown += new KeyEventHandler(f447_bcdt_nhan_vien_KeyDown);
        }

       private void f447_bcdt_nhan_vien_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
...
//
		...
		//
		//
		private void f447_bcdt_nhan_vien_Load(object sender, System.EventArgs e) {
			try{
