///************************************************
/// Generated by: TuNA
/// Date: 23-05-2014 03:03:25
/// Goal: Create Form for V_BC_DOANH_THU_BAC_SY
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f442_bcdt_bac_sy : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f442_bcdt_bac_sy));
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(686, 206);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(160, 138);
            this.m_lbl_doanh_thu.Name = "m_lbl_doanh_thu";
            this.m_lbl_doanh_thu.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_doanh_thu.TabIndex = 2929;
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(160, 116);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 2923;
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(439, 79);
            ...
            this.m_dat_den_ngay.TabIndex = 2920;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(565, 43);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 2916;
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(144, 48);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(401, 20);
            this.m_txt_tim_kiem.TabIndex = 2915;
            // 
            // label4
            // 
            ...
            this.Name = "f442_bcdt_bac_sy";
            this.Text = "F442-Báo cáo doanh thu theo bác sỹ";
            this.Load += new System.EventHandler(this.f442_bcdt_bac_sy_Load);
...
,TEN_BAC_SY = 1
        ...
        private const String m_str_tim_kiem = "Nhập tên bác sỹ cần tìm";
        DateTime v_dat_ngay_bd;
        DateTime v_dat_ngay_kt;
		BKI_QLHT.DS.V_BC_DOANH_THU_BAC_SY m_v_ds = new BKI_QLHT.DS.V_BC_DOANH_THU_BAC_SY();
		US_V_BC_DOANH_THU_BAC_SY m_v_us = new US_V_BC_DOANH_THU_BAC_SY();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_DOANH_THU_BAC_SY"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds._V_BC_DOANH_THU_BAC_SY)
            {
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_BAC_SY.TEN_BAC_SY].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
            ...
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_BAC_SY.DOANH_THU, e_col_Number.DOANH_THU);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_BAC_SY.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_DOANH_THU_BAC_SY.TEN_BAC_SY, e_col_Number.TEN_BAC_SY);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds._V_BC_DOANH_THU_BAC_SY.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds._V_BC_DOANH_THU_BAC_SY.Count; i++)
            {
            ...
            m_lbl_count.Text = m_v_ds._V_BC_DOANH_THU_BAC_SY.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
            set_search_format_before();
        }
        private void grid2us_object(US_V_BC_DOANH_THU_BAC_SY i_us
			, int i_grid_row) {
			DataRow v_dr;
        ...
        private void us_object2grid(US_V_BC_DOANH_THU_BAC_SY i_us
			, int i_grid_row) {
        ...
        private void set_define_events()
        {
            ...
            this.KeyDown += new KeyEventHandler(f442_bcdt_bac_sy_KeyDown);
        }

       private void f442_bcdt_bac_sy_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
...
//
		...
		//
		//
		private void f442_bcdt_bac_sy_Load(object sender, System.EventArgs e) {
			try{
