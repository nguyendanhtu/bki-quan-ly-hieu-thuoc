///************************************************
/// Generated by: NinhVH
/// Date: 22-05-2014 01:53:44
/// Goal: Create Form for V_BC_NHAP_THUOC_THEO_GIA
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f440_bcnt_theo_gia : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f440_bcnt_theo_gia));
            ...
            this.m_pnl_out_place_dm.Size = new System.Drawing.Size(704, 36);
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(704, 238);
            ...
            this.m_dat_den_ngay.TabIndex = 2889;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_dat_tu_ngay.TabIndex = 2888;
            // 
            // label6
            // 
            ...
            this.m_cmd_search.TabIndex = 2885;
            ...
            this.m_txt_tim_kiem.TabIndex = 2884;
            // 
            // m_lbl_nguoi_lam_bc
            // 
...
,DON_VI_TINH = 5
        ...
        private const String m_str_tim_kiem = "Nhập tên thuốc, mã giao dịch cần tìm";
        DateTime v_dat_ngay_bd;
        DateTime v_dat_ngay_kt;
		DS_V_BC_NHAP_THUOC_THEO_GIA m_v_ds = new DS_V_BC_NHAP_THUOC_THEO_GIA();
		US_V_BC_NHAP_THUOC_THEO_GIA m_v_us = new US_V_BC_NHAP_THUOC_THEO_GIA();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_NHAP_THUOC_THEO_GIA"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_NHAP_THUOC_THEO_GIA)
            {
                v_acsc_search.Add(dr[V_BC_NHAP_THUOC_THEO_GIA.MA_GIAO_DICH].ToString());
                v_acsc_search.Add(dr[V_BC_NHAP_THUOC_THEO_GIA.TEN_THUOC].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_NHAP_THUOC_THEO_GIA.MA_GIAO_DICH, e_col_Number.MA_GIAO_DICH);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_GIA.GIA_NHAP, e_col_Number.GIA_NHAP);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_GIA.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_GIA.TEN_THUOC, e_col_Number.TEN_THUOC);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_GIA.DON_VI_TINH, e_col_Number.DON_VI_TINH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_NHAP_THUOC_THEO_GIA.NewRow());
			return v_obj_trans;			
		}
		...
		private void grid2us_object(US_V_BC_NHAP_THUOC_THEO_GIA i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_NHAP_THUOC_THEO_GIA i_us
			, int i_grid_row) {
...
//
		...
		//
		//
		private void f440_bcnt_theo_gia_Load(object sender, System.EventArgs e) {
			try{
