///************************************************
/// Generated by: TuNA
/// Date: 18-05-2014 10:32:20
/// Goal: Create Form for V_BC_NHAP_THUOC_THEO_CAC_NCC
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f426_bcnt_theo_cac_ncc : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f426_bcnt_theo_cac_ncc));
            ...
            this.m_cmd_exit.Location = new System.Drawing.Point(654, 4);
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(746, 278);
            ...
            this.m_lbl_nguoi_lam_bc.Location = new System.Drawing.Point(674, 89);
            ...
            this.m_lbl_ngay_lam_bc.Location = new System.Drawing.Point(674, 111);
            ...
            this.label3.Location = new System.Drawing.Point(557, 111);
            ...
            this.m_lbl_nguoi_lam_bao_cao.Location = new System.Drawing.Point(557, 89);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(167, 111);
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(167, 89);
            ...
            this.label7.Location = new System.Drawing.Point(377, 58);
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(447, 52);
            ...
            this.m_dat_tu_ngay.Location = new System.Drawing.Point(152, 52);
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(573, 16);
            ...
            this.Name = "f426_bcnt_theo_cac_ncc";
            this.Text = "f426_bcnt_theo_cac_ncc";
            this.Load += new System.EventHandler(this.f426_bcnt_theo_cac_ncc_Load);
...
,DON_VI_TINH = 4
		...
		DS_V_BC_NHAP_THUOC_THEO_CAC_NCC m_v_ds = new DS_V_BC_NHAP_THUOC_THEO_CAC_NCC();
		US_V_BC_NHAP_THUOC_THEO_CAC_NCC m_v_us = new US_V_BC_NHAP_THUOC_THEO_CAC_NCC();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_NHAP_THUOC_THEO_CAC_NCC"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NCC)
            {
                v_acsc_search.Add(dr[V_BC_NHAP_THUOC_THEO_CAC_NCC.TEN_NCC].ToString());
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NCC.TEN_NCC, e_col_Number.TEN_NCC);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NCC.THANH_TIEN, e_col_Number.THANH_TIEN);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NCC.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NCC.TONG_SO_LUONG_NHAP, e_col_Number.TONG_SO_LUONG_NHAP);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NCC.DON_VI_TINH, e_col_Number.DON_VI_TINH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NCC.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NCC.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_NHAP_THUOC_THEO_CAC_NCC.THANH_TIEN]);
            }
            ...
            m_lbl_count.Text = m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NCC.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_NHAP_THUOC_THEO_CAC_NCC i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_NHAP_THUOC_THEO_CAC_NCC i_us
			, int i_grid_row) {
...
//
		...
		//
		//
		private void f426_bcnt_theo_cac_ncc_Load(object sender, System.EventArgs e) {
			try{
