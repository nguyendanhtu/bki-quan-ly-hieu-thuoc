...
namespace BKI_QLHT
{
	...
	public class f419_bao_cao_doanh_thu_theo_ncc_0 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f419_bao_cao_doanh_thu_theo_ncc_0));
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(543, 17);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 2779;
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(122, 22);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(401, 20);
            this.m_txt_tim_kiem.TabIndex = 2778;
            // 
            // m_lbl_nguoi_lam_bc
            // 
...
,DOANH_THU = 2
        ...
        {
            int count = m_v_ds.Tables["V_BAO_CAO_DOANH_THU_THEO_NCC_0"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BAO_CAO_DOANH_THU_THEO_NCC_0)
            {
                v_acsc_search.Add(dr[V_BAO_CAO_DOANH_THU_THEO_NCC_0.TEN_NCC].ToString());
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BAO_CAO_DOANH_THU_THEO_NCC_0.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            m_lbl_count.Text = m_v_ds.V_BAO_CAO_DOANH_THU_THEO_NCC_0.Count.ToString(CultureInfo.InvariantCulture);
            decimal v_dc_tong_doanh_thu = 0;
            //m_v_us.get_tong_doanh_thu(v_dc_tong_doanh_thu);
            for (int i = 0; i < m_v_ds.V_BAO_CAO_DOANH_THU_THEO_NCC_0.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BAO_CAO_DOANH_THU_THEO_NCC_0.DOANH_THU]);
            }
