///************************************************
/// Generated by: TuNA
/// Date: 19-05-2014 11:56:17
/// Goal: Create Form for V_BC_NHAP_THUOC_THEO_CAC_NGAY
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f428_bcnt_theo_cac_ngay : System.Windows.Forms.Form
	{
		...
		public f428_bcnt_theo_cac_ngay()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f428_bcnt_theo_cac_ngay));
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(686, 245);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(154, 102);
            this.m_lbl_doanh_thu.Name = "m_lbl_doanh_thu";
            this.m_lbl_doanh_thu.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_doanh_thu.TabIndex = 2917;
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(154, 80);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 2915;
            ...
            this.label1.TabIndex = 2914;
            this.label1.Text = "Số kết quả trong báo cáo";
            // 
            // label7
            // 
            this.label7.AutoSize = true;
            this.label7.Location = new System.Drawing.Point(328, 48);
            this.label7.Name = "label7";
            this.label7.Size = new System.Drawing.Size(53, 13);
            this.label7.TabIndex = 2913;
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(398, 42);
            ...
            this.m_dat_den_ngay.TabIndex = 2912;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(528, 7);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 2908;
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(139, 12);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(365, 20);
            this.m_txt_tim_kiem.TabIndex = 2907;
            // 
            // m_cmd_xuat_excel
            // 
            ...
            this.Name = "f428_bcnt_theo_cac_ngay";
            this.Text = "f428_bcnt_theo_cac_ngay";
            this.Load += new System.EventHandler(this.f428_bcnt_theo_cac_ngay_Load);
...
,DON_VI_TINH = 3
        ...
        private const String m_str_tim_kiem = "Nhập ngày nhập thuốc cần tìm";
        DateTime v_dat_ngay_bd;
        DateTime v_dat_ngay_kt;
		DS_V_BC_NHAP_THUOC_THEO_CAC_NGAY m_v_ds = new DS_V_BC_NHAP_THUOC_THEO_CAC_NGAY();
		US_V_BC_NHAP_THUOC_THEO_CAC_NGAY m_v_us = new US_V_BC_NHAP_THUOC_THEO_CAC_NGAY();
		#endregion
        ...
        private void load_custom_source_2_m_txt_tim_kiem()
        {
            ...
            foreach (DataRow dr in m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NGAY)
            {
                v_acsc_search.Add(dr[V_BC_NHAP_THUOC_THEO_CAC_NGAY.NGAY_GIAO_DICH].ToString());
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY.THANH_TIEN, e_col_Number.THANH_TIEN);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY.TONG_SO_LUONG_NHAP, e_col_Number.TONG_SO_LUONG_NHAP);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NGAY.DON_VI_TINH, e_col_Number.DON_VI_TINH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NGAY.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NGAY.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_NHAP_THUOC_THEO_CAC_NGAY.THANH_TIEN]);
            }
            ...
            m_lbl_count.Text = m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NGAY.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_NHAP_THUOC_THEO_CAC_NGAY i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_NHAP_THUOC_THEO_CAC_NGAY i_us
			, int i_grid_row) {
...
//
		...
		//
		//
		private void f428_bcnt_theo_cac_ngay_Load(object sender, System.EventArgs e) {
			try{
