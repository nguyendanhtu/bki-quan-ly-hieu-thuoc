///************************************************
/// Generated by: TuNA
/// Date: 24-05-2014 09:17:57
/// Goal: Create Form for V_BC_NHAP_THUOC_NHAN_VIEN_DE
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f454_bcnt_nhan_vien_de : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.m_cmd_exit.Location = new System.Drawing.Point(649, 4);
            ...
            this.m_fg.Location = new System.Drawing.Point(0, 191);
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(741, 317);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(166, 156);
            ...
            this.m_lbl_nguoi_lam_bc.Location = new System.Drawing.Point(599, 134);
            ...
            this.m_lbl_ngay_lam_bc.Location = new System.Drawing.Point(599, 156);
            ...
            this.label3.Location = new System.Drawing.Point(482, 156);
            ...
            this.m_lbl_nguoi_lam_bao_cao.Location = new System.Drawing.Point(482, 134);
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(166, 134);
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(445, 97);
            ...
            this.m_dat_tu_ngay.Location = new System.Drawing.Point(150, 97);
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(571, 61);
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(150, 66);
            ...
            this.label4.Text = "Báo cáo nhập thuốc chi tiết theo nhân viên";
            // 
            // f454_bcnt_nhan_vien_de
            // 
...
,THANH_TIEN = 8
        ...
        BKI_QLHT.DS.V_BC_NHAP_THUOC_NHAN_VIEN_DE m_v_ds = new BKI_QLHT.DS.V_BC_NHAP_THUOC_NHAN_VIEN_DE();
		US_V_BC_NHAP_THUOC_NHAN_VIEN_DE m_v_us = new US_V_BC_NHAP_THUOC_NHAN_VIEN_DE();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_NHAP_THUOC_NHAN_VIEN_DE"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds._V_BC_NHAP_THUOC_NHAN_VIEN_DE)
            {
                //v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NGAY_N_NHAN_VIEN.MA_GIAO_DICH].ToString());
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NHAN_VIEN_DE.TEN_NHAN_VIEN].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
            ...
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NHAN_VIEN_DE.GIA_NHAP, e_col_Number.GIA_NHAP);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NHAN_VIEN_DE.MA_GIAO_DICH, e_col_Number.MA_GIAO_DICH);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NHAN_VIEN_DE.DON_VI_TINH, e_col_Number.DON_VI_TINH);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NHAN_VIEN_DE.SO_LUONG_NHAP, e_col_Number.SO_LUONG_NHAP);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NHAN_VIEN_DE.TEN_NHAN_VIEN, e_col_Number.TEN_NHAN_VIEN);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NHAN_VIEN_DE.TEN_THUOC, e_col_Number.TEN_THUOC);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NHAN_VIEN_DE.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_NHAP_THUOC_NHAN_VIEN_DE.THANH_TIEN, e_col_Number.THANH_TIEN);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds._V_BC_NHAP_THUOC_NHAN_VIEN_DE.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds._V_BC_NHAP_THUOC_NHAN_VIEN_DE.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][BKI_QLHT.DS.CDBNames
                .V_BC_NHAP_THUOC_NHAN_VIEN_DE.THANH_TIEN]);
            }
            ...
            m_fg.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum // chỗ này dùng hàm count tức là để đếm, có thể dùng các hàm khác thay thế
              , 1
              , (int)e_col_Number.MA_GIAO_DICH // chỗ này là tên trường mà mình nhóm
              , (int)e_col_Number.THANH_TIEN // chỗ này là tên trường mà mình Count
              , "{0}"
              );
            ...
            m_lbl_count.Text = m_v_ds._V_BC_NHAP_THUOC_NHAN_VIEN_DE.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_NHAP_THUOC_NHAN_VIEN_DE i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_NHAP_THUOC_NHAN_VIEN_DE i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f454_bao_cao_nhap_thuoc_chi_tiet_theo_nhan_vien.xlsx", 10, 1);
            //người làm báo cáo
        ...
        private void set_define_events()
        {
            ...
            this.KeyDown += new KeyEventHandler(f454_bcnt_nhan_vien_de_KeyDown);
        }

       private void f454_bcnt_nhan_vien_de_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
...
//
		...
		//
		//
		private void f454_bcnt_nhan_vien_de_Load(object sender, System.EventArgs e) {
			try{
