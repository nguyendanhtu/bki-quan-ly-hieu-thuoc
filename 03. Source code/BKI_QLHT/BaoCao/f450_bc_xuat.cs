///************************************************
/// Generated by: TuNA
/// Date: 24-05-2014 12:30:56
/// Goal: Create Form for V_BC_XUAT
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f450_bc_xuat : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f450_bc_xuat));
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(171, 106);
            this.m_lbl_doanh_thu.Name = "m_lbl_doanh_thu";
            this.m_lbl_doanh_thu.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_doanh_thu.TabIndex = 3049;
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(171, 84);
            this.m_lbl_count.Name = "m_lbl_count";
            this.m_lbl_count.Size = new System.Drawing.Size(28, 13);
            this.m_lbl_count.TabIndex = 3043;
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(450, 47);
            ...
            this.m_dat_den_ngay.TabIndex = 3040;
            // 
            // m_dat_tu_ngay
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(576, 11);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(88, 28);
            this.m_cmd_search.TabIndex = 3036;
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(155, 16);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(401, 20);
            this.m_txt_tim_kiem.TabIndex = 3035;
            // 
            // m_cmd_xuat_excel
            // 
            ...
            this.Name = "f450_bc_xuat";
            this.Text = "f450_bc_xuat";
            this.Load += new System.EventHandler(this.f450_bc_xuat_Load);
...
,DON_VI_TINH = 5
        ...
        private const String m_str_tim_kiem = "Nhập mã giao dịch, tên thuốc cần tìm";
        DateTime v_dat_ngay_bd;
        DateTime v_dat_ngay_kt;
        BKI_QLHT.DS.V_BC_XUAT m_v_ds = new BKI_QLHT.DS.V_BC_XUAT();
		US_V_BC_XUAT m_v_us = new US_V_BC_XUAT();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_XUAT"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds._V_BC_XUAT)
            {
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_XUAT.MA_GIAO_DICH].ToString());
                v_acsc_search.Add(dr[BKI_QLHT.DS.CDBNames.V_BC_XUAT.TEN_THUOC].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_XUAT.MA_GIAO_DICH, e_col_Number.MA_GIAO_DICH);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_XUAT.THANH_TIEN, e_col_Number.THANH_TIEN);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_XUAT.SO_LUONG_BAN, e_col_Number.SO_LUONG_BAN);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_XUAT.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_XUAT.TEN_THUOC, e_col_Number.TEN_THUOC);
            v_htb.Add(BKI_QLHT.DS.CDBNames.V_BC_XUAT.DON_VI_TINH, e_col_Number.DON_VI_TINH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds._V_BC_XUAT.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            m_lbl_count.Text = m_v_ds._V_BC_XUAT.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_XUAT i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_XUAT i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f450_bao_cao_xuat.xlsx", 10, 1);
            //người làm báo cáo
        ...
        private void set_define_events()
        {
            ...
            this.KeyDown += new KeyEventHandler(f450_bc_xuat_KeyDown);
        }

        private void f450_bc_xuat_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
...
//
		...
		//
		//
		private void f450_bc_xuat_Load(object sender, System.EventArgs e) {
			try{
