///************************************************
/// Generated by: TuNA
/// Date: 19-05-2014 02:02:51
/// Goal: Create Form for V_BC_NHAP_THUOC_THEO_CAC_NCC_DE
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f427_bcnt_theo_cac_ncc_de : System.Windows.Forms.Form
	{
		...
		public f427_bcnt_theo_cac_ncc_de()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f427_bcnt_theo_cac_ncc_de));
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(875, 242);
            ...
            this.m_lbl_nguoi_lam_bc.Location = new System.Drawing.Point(770, 91);
            ...
            this.m_lbl_ngay_lam_bc.Location = new System.Drawing.Point(770, 113);
            ...
            this.m_lbl_nguoi_lam_bao_cao.Location = new System.Drawing.Point(653, 91);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(200, 113);
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(200, 91);
            ...
            this.label7.Location = new System.Drawing.Point(442, 49);
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(512, 43);
            ...
            this.m_dat_tu_ngay.Location = new System.Drawing.Point(217, 43);
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(638, 7);
            ...
            this.Name = "f427_bcnt_theo_cac_ncc_de";
            this.Text = "f427_bcnt_theo_cac_ncc_de";
            this.Load += new System.EventHandler(this.f427_bcnt_theo_cac_ncc_de_Load);
...
,DON_VI_TINH = 5
		...
		DS_V_BC_NHAP_THUOC_THEO_CAC_NCC_de m_v_ds = new DS_V_BC_NHAP_THUOC_THEO_CAC_NCC_de();
		US_V_BC_NHAP_THUOC_THEO_CAC_NCC_DE m_v_us = new US_V_BC_NHAP_THUOC_THEO_CAC_NCC_DE();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_NHAP_THUOC_THEO_CAC_NCC_DE"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NCC_de)
            {
                v_acsc_search.Add(dr[V_BC_NHAP_THUOC_THEO_CAC_NCC_de.TEN_NCC].ToString());
                v_acsc_search.Add(dr[V_BC_NHAP_THUOC_THEO_CAC_NCC_de.TEN_THUOC].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NCC_de.TEN_NCC, e_col_Number.TEN_NCC);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NCC_de.SO_LUONG_NHAP, e_col_Number.SO_LUONG_NHAP);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NCC_de.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NCC_de.TEN_THUOC, e_col_Number.TEN_THUOC);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NCC_de.THANH_TIEN, e_col_Number.THANH_TIEN);
			v_htb.Add(V_BC_NHAP_THUOC_THEO_CAC_NCC_de.DON_VI_TINH, e_col_Number.DON_VI_TINH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NCC_de.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NCC_de.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_NHAP_THUOC_THEO_CAC_NCC_de.THANH_TIEN]);
            }
            ...
            m_lbl_count.Text = m_v_ds.V_BC_NHAP_THUOC_THEO_CAC_NCC_de.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
        ...
        private void grid2us_object(US_V_BC_NHAP_THUOC_THEO_CAC_NCC_DE i_us
            , int i_grid_row)
        {
            DataRow v_dr;
        ...
        private void us_object2grid(US_V_BC_NHAP_THUOC_THEO_CAC_NCC_DE i_us
            , int i_grid_row)
        {
...
//
		...
		//
		//
		private void f427_bcnt_theo_cac_ncc_de_Load(object sender, System.EventArgs e) {
			try{
