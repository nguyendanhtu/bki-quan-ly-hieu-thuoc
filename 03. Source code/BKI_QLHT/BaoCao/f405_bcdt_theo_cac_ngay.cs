///************************************************
/// Generated by: TuNA
/// Date: 14-05-2014 11:41:13
/// Goal: Create Form for V_BC_DOANH_THU_THEO_CAC_NGAY
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f405_bcdt_theo_cac_ngay : System.Windows.Forms.Form
	{
		...
		public f405_bcdt_theo_cac_ngay()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f405_bcdt_theo_cac_ngay));
            ...
            this.m_pnl_out_place_dm.Size = new System.Drawing.Size(714, 36);
            ...
            this.m_cmd_exit.Location = new System.Drawing.Point(622, 4);
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(714, 242);
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(461, 43);
            ...
            this.m_dat_tu_ngay.Location = new System.Drawing.Point(166, 43);
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(587, 7);
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(166, 12);
            ...
            this.m_lbl_nguoi_lam_bc.Location = new System.Drawing.Point(607, 82);
            ...
            this.m_lbl_ngay_lam_bc.Location = new System.Drawing.Point(607, 104);
            ...
            this.m_lbl_nguoi_lam_bao_cao.Location = new System.Drawing.Point(490, 82);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(181, 104);
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(181, 82);
            ...
            this.Name = "f405_bcdt_theo_cac_ngay";
            this.Text = "f405_bcdt_theo_cac_ngay";
            this.Load += new System.EventHandler(this.f405_bcdt_theo_cac_ngay_Load);
...
,DON_VI_TINH = 3
        ...
        private const String m_str_tim_kiem = "Nhập ngày cần tìm  ";
        DateTime v_dat_ngay_bd;
        DateTime v_dat_ngay_kt;
		DS_V_BC_DOANH_THU_THEO_CAC_NGAY m_v_ds = new DS_V_BC_DOANH_THU_THEO_CAC_NGAY();
		US_V_BC_DOANH_THU_THEO_CAC_NGAY m_v_us = new US_V_BC_DOANH_THU_THEO_CAC_NGAY();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_DOANH_THU_THEO_CAC_NGAY"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_DOANH_THU_THEO_CAC_NGAY)
            {
                v_acsc_search.Add(dr[V_BC_DOANH_THU_THEO_CAC_NGAY.NGAY_GIAO_DICH].ToString());
            }
...
//            m_fg.Cols[(int)e_col_Number.NGAY_GIAO_DICH].Visible = false;
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NGAY.DOANH_THU, e_col_Number.DOANH_THU);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NGAY.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NGAY.TONG_SO_LUONG_BAN, e_col_Number.TONG_SO_LUONG_BAN);
			v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NGAY.DON_VI_TINH, e_col_Number.DON_VI_TINH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_DOANH_THU_THEO_CAC_NGAY.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds.V_BC_DOANH_THU_THEO_CAC_NGAY.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_DOANH_THU_THEO_CAC_NGAY.DOANH_THU]);
            }
            ...
            m_lbl_count.Text = m_v_ds.V_BC_DOANH_THU_THEO_CAC_NGAY.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_DOANH_THU_THEO_CAC_NGAY i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_DOANH_THU_THEO_CAC_NGAY i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f405_bao_cao_doanh_thu_theo_cac_ngay_giao_dich.xlsx", 10, 1);
            //người làm báo cáo
...
//
		...
		//
		//
		private void f405_bcdt_theo_cac_ngay_Load(object sender, System.EventArgs e) {
			try{
