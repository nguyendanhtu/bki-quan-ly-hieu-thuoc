///************************************************
/// Generated by: TuNA
/// Date: 17-05-2014 09:57:08
/// Goal: Create Form for V_BC_BAN_THUOC
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f421_bc_ban_thuoc : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f421_bc_ban_thuoc));
            ...
            this.m_pnl_out_place_dm.Size = new System.Drawing.Size(833, 36);
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(833, 243);
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(528, 45);
            ...
            this.m_dat_tu_ngay.Location = new System.Drawing.Point(233, 45);
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(654, 9);
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(233, 14);
            ...
            this.m_lbl_nguoi_lam_bc.Location = new System.Drawing.Point(674, 84);
            ...
            this.m_lbl_ngay_lam_bc.Location = new System.Drawing.Point(674, 106);
            ...
            this.label3.Location = new System.Drawing.Point(557, 106);
            ...
            this.m_lbl_nguoi_lam_bao_cao.Location = new System.Drawing.Point(557, 84);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(248, 106);
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(248, 84);
            ...
            this.Name = "f421_bc_ban_thuoc";
            this.Text = "f421_bc_ban_thuoc";
            this.Load += new System.EventHandler(this.f421_bc_ban_thuoc_Load);
...
,DON_VI_TINH = 5
        ...
        private const String m_str_tim_kiem = "Nhập tên thuốc, tên khách hàng cần tìm";
        DateTime v_dat_ngay_bd;
        DateTime v_dat_ngay_kt;
		DS_V_BC_BAN_THUOC m_v_ds = new DS_V_BC_BAN_THUOC();
		US_V_BC_BAN_THUOC m_v_us = new US_V_BC_BAN_THUOC();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_BAN_THUOC"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_BC_BAN_THUOC)
            {
                v_acsc_search.Add(dr[V_BC_BAN_THUOC.TEN_THUOC].ToString());
                v_acsc_search.Add(dr[V_BC_BAN_THUOC.TEN_KHACH_HANG].ToString());
            }
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BC_BAN_THUOC.THANH_TIEN, e_col_Number.THANH_TIEN);
			v_htb.Add(V_BC_BAN_THUOC.GIA_BAN, e_col_Number.GIA_BAN);
			v_htb.Add(V_BC_BAN_THUOC.SO_LUONG_BAN, e_col_Number.SO_LUONG_BAN);
			v_htb.Add(V_BC_BAN_THUOC.TEN_KHACH_HANG, e_col_Number.TEN_KHACH_HANG);
			v_htb.Add(V_BC_BAN_THUOC.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
			v_htb.Add(V_BC_BAN_THUOC.TEN_THUOC, e_col_Number.TEN_THUOC);
			v_htb.Add(V_BC_BAN_THUOC.DON_VI_TINH, e_col_Number.DON_VI_TINH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_BAN_THUOC.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds.V_BC_BAN_THUOC.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_BAN_THUOC.THANH_TIEN]);
            }
            ...
            m_lbl_count.Text = m_v_ds.V_BC_BAN_THUOC.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_BAN_THUOC i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_BAN_THUOC i_us
			, int i_grid_row) {
...
//
		...
		//
		//
		private void f421_bc_ban_thuoc_Load(object sender, System.EventArgs e) {
			try{
