///************************************************
/// Generated by: TuNA
/// Date: 14-05-2014 12:24:10
/// Goal: Create Form for V_BC_DOANH_THU_THEO_CAC_NCC
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f403_bao_cao_doanh_thu_theo_cac_ncc : System.Windows.Forms.Form
	{
		...
		public f403_bao_cao_doanh_thu_theo_cac_ncc()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f403_bao_cao_doanh_thu_theo_cac_ncc));
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(712, 217);
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(464, 70);
            ...
            this.m_dat_tu_ngay.Location = new System.Drawing.Point(169, 70);
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(590, 34);
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(169, 39);
            ...
            this.m_lbl_nguoi_lam_bc.Location = new System.Drawing.Point(610, 109);
            ...
            this.m_lbl_ngay_lam_bc.Location = new System.Drawing.Point(610, 131);
            ...
            this.m_lbl_nguoi_lam_bao_cao.Location = new System.Drawing.Point(493, 109);
            ...
            this.m_lbl_doanh_thu.Location = new System.Drawing.Point(184, 131);
            ...
            this.m_lbl_count.Location = new System.Drawing.Point(184, 109);
            ...
            this.label4.TabIndex = 2832;
            this.label4.Text = "Báo cáo doanh thu theo nhà cung cấp";
            // 
            // f403_bao_cao_doanh_thu_theo_cac_ncc
            // 
            ...
            this.Name = "f403_bao_cao_doanh_thu_theo_cac_ncc";
            this.Text = "F403-Báo cáo doanh thu theo nhà cung cấp";
            this.Load += new System.EventHandler(this.f403_bao_cao_doanh_thu_theo_cac_ncc_Load);
...
,DON_VI_TINH = 4
		...
		DS_V_BC_DOANH_THU_THEO_CAC_NCC m_v_ds = new DS_V_BC_DOANH_THU_THEO_CAC_NCC();
		US_V_BC_DOANH_THU_THEO_CAC_NCC m_v_us = new US_V_BC_DOANH_THU_THEO_CAC_NCC();
		#endregion
        ...
        {
            int count = m_v_ds.Tables["V_BC_DOANH_THU_THEO_CAC_NCC"].Rows.Count;
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
            ...
            v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NCC.TEN_NCC, e_col_Number.TEN_NCC);
            v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NCC.DOANH_THU, e_col_Number.DOANH_THU);
            v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NCC.NGAY_GIAO_DICH, e_col_Number.NGAY_GIAO_DICH);
            v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NCC.TONG_SO_LUONG_BAN, e_col_Number.TONG_SO_LUONG_BAN);
            v_htb.Add(V_BC_DOANH_THU_THEO_CAC_NCC.DON_VI_TINH, e_col_Number.DON_VI_TINH);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_BC_DOANH_THU_THEO_CAC_NCC.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){
            ...
            for (int i = 0; i < m_v_ds.V_BC_DOANH_THU_THEO_CAC_NCC.Count; i++)
            {
                v_dc_tong_doanh_thu += CIPConvert.ToDecimal(m_v_ds.Tables[0].Rows[i][V_BC_DOANH_THU_THEO_CAC_NCC.DOANH_THU]);
            }
            ...
            m_fg.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Count // chỗ này dùng hàm count tức là để đếm, có thể dùng các hàm khác thay thế
              ...
              , (int)e_col_Number.TONG_SO_LUONG_BAN // chỗ này là tên trường mà mình Count
              , "{0}"
              );
            ...
            m_lbl_count.Text = m_v_ds.V_BC_DOANH_THU_THEO_CAC_NCC.Count.ToString(CultureInfo.InvariantCulture);
            m_fg.Redraw = true;
		...
		private void grid2us_object(US_V_BC_DOANH_THU_THEO_CAC_NCC i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_BC_DOANH_THU_THEO_CAC_NCC i_us
			, int i_grid_row) {
        ...
        private void export_2_excel()
        {
            ...
            CExcelReport v_obj_excel_rpt = new CExcelReport("f403_bao_cao_doanh_thu_theo_cac_ncc.xlsx", 10, 1);
            //người làm báo cáo
...
//
		...
		//
		//
		private void f403_bao_cao_doanh_thu_theo_cac_ncc_Load(object sender, System.EventArgs e) {
			try{
