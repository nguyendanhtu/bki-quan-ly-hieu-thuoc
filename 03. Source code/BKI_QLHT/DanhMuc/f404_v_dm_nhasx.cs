///************************************************
/// Generated by: TuNA
/// Date: 30-04-2014 11:55:10
/// Goal: Create Form for V_DM_NHASX
///************************************************
...
namespace BKI_QLHT
{
	...
	public class f404_v_dm_nhasx : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f404_v_dm_nhasx));
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(515, 21);
            ...
            this.m_txt_tim_kiem.Location = new System.Drawing.Point(148, 26);
            this.m_txt_tim_kiem.Name = "m_txt_tim_kiem";
            this.m_txt_tim_kiem.Size = new System.Drawing.Size(336, 20);
            this.m_txt_tim_kiem.TabIndex = 27;
            // 
            // label4
            // 
            ...
            this.Name = "f404_v_dm_nhasx";
            this.Text = "f404_v_dm_nhasx";
            this.Load += new System.EventHandler(this.f404_v_dm_nhasx_Load);
...
,SDT = 3
		...
		DS_V_DM_NHASX m_v_ds = new DS_V_DM_NHASX();
		US_V_DM_NHASX m_v_us = new US_V_DM_NHASX();
        DS_DM_NCC_NSX_NHASX m_ds = new DS_DM_NCC_NSX_NHASX();
        US_DM_NCC_NSX_NHASX m_us = new US_DM_NCC_NSX_NHASX();
        private const String m_str_tim_kiem = "Nhập tên nhà sản xuất cần tìm";
        ...
        {
            int count = m_v_ds.Tables["V_DM_NHASX"].Rows.Count;
            AutoCompleteStringCollection v_acsc_search = new AutoCompleteStringCollection();
            foreach (DataRow dr in m_v_ds.V_DM_NHASX)
            {
                v_acsc_search.Add(dr[V_DM_NHASX.TEN_NHASX].ToString());
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_DM_NHASX.MA_NHASX, e_col_Number.MA_NHASX);
			v_htb.Add(V_DM_NHASX.TEN_NHASX, e_col_Number.TEN_NHASX);
			v_htb.Add(V_DM_NHASX.DIA_CHI, e_col_Number.DIA_CHI);
			v_htb.Add(V_DM_NHASX.SDT, e_col_Number.SDT);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_v_ds.V_DM_NHASX.NewRow());
			return v_obj_trans;			
		}
		...
		private void us_object2grid(US_V_DM_NHASX i_us
			, int i_grid_row) {
		...
		private void insert_v_dm_nhasx(){	
		...
		private void delete_v_dm_nhasx(){
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
        ...
        //private void view_v_dm_nhasx(){			
        //    if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
        //    if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
        //    grid2us_object(m_v_us, m_fg.Row);
        ////	f404_v_dm_nhasx_DE v_fDE = new f404_v_dm_nhasx_DE();			
        ////	v_fDE.display(m_us);
        //}
...
//
		...
		//
		//
		private void f404_v_dm_nhasx_Load(object sender, System.EventArgs e) {
			try{
