...
namespace BKI_QLHT
{
	...
	public class f501_v_dm_nhom_thuoc : System.Windows.Forms.Form
	{
        ...
        private ComboBox m_cbo_danh_muc;
		private System.ComponentModel.IContainer components;

		public f501_v_dm_nhom_thuoc()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f501_v_dm_nhom_thuoc));
            ...
            this.m_cmd_huy.Location = new System.Drawing.Point(387, 128);
            ...
            this.m_cmd_save.Location = new System.Drawing.Point(281, 128);
            ...
            // m_txt_ghi_chu
            // 
            this.m_txt_ghi_chu.Location = new System.Drawing.Point(237, 102);
            ...
            this.m_cbo_danh_muc.Location = new System.Drawing.Point(237, 68);
            this.m_cbo_danh_muc.Name = "m_cbo_danh_muc";
            this.m_cbo_danh_muc.Size = new System.Drawing.Size(269, 21);
            this.m_cbo_danh_muc.TabIndex = 40;
            // 
            // f501_v_dm_nhom_thuoc
            // 
            ...
            this.Controls.Add(this.m_txt_ten_nhom_thuoc);
            this.Controls.Add(this.panel2);
            this.Controls.Add(this.panel1);
            this.Controls.Add(this.m_grv_nhom_thuoc);
            this.Controls.Add(this.m_pnl_out_place_dm);
            this.Name = "f501_v_dm_nhom_thuoc";
            this.Text = "f501_v_dm_nhom_thuoc";
            this.Load += new System.EventHandler(this.f501_v_dm_nhom_thuoc_Load);
        ...
        DS_DM_NHOM_THUOC m_ds_nhom_thuoc = new DS_DM_NHOM_THUOC();
		...
		private void grid2us_object(US_DM_NHOM_THUOC i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_DM_NHOM_THUOC i_us
			, int i_grid_row) {
		...
		//	f501_v_dm_nhom_thuoc_DE v_fDE = new  f501_v_dm_nhom_thuoc_DE();								
		//	v_fDE.display();
			load_data_2_grid();
		}
		...
		private void update_v_dm_nhom_thuoc(){			
			...
			grid2us_object(m_us_nhom_thuoc, m_grv_nhom_thuoc.Row);
		//	f501_v_dm_nhom_thuoc_DE v_fDE = new f501_v_dm_nhom_thuoc_DE();
		   display_update(m_us_nhom_thuoc);
			load_data_2_grid();
		}
        ...
        //    grid2us_object(m_us_nhom_thuoc, m_grv_nhom_thuoc.Row);
        ////	f501_v_dm_nhom_thuoc_DE v_fDE = new f501_v_dm_nhom_thuoc_DE();			
        //        display_insert(m_us_nhom_thuoc);
        //}

        private void display_update(US_DM_NHOM_THUOC m_us_view)
        {
            m_e_form_mode = DataEntryFormMode.UpdateDataState;
            m_us_nhom_thuoc = m_us_view;
            us_obj_2_form();
        }
        ...
        private void form_2_us_obj(){
            ...
            //m_us_nhom_thuoc.dcID_DANH_MUC_THUOC = m_cbo_danh_muc;
        ...
        private void us_obj_2_form() {
            m_txt_ten_nhom_thuoc.Text = m_us_nhom_thuoc.strTEN_NHOM;
            //m_cbo_danh_muc.Validated = m_us_nhom_thuoc.dcID_DANH_MUC_THUOC;
            m_cbo_danh_muc.SelectedValue = m_us_nhom_thuoc.dcID_DANH_MUC_THUOC;
            m_txt_ghi_chu.Text = m_us_nhom_thuoc.strGHI_CHU;
        }
        private void save_data()
        {
            ...
            switch (m_e_form_mode)
            {
                ...
                case DataEntryFormMode.UpdateDataState:
                    ...
                    break;
                default: m_us_nhom_thuoc.Insert(); break;
            }
            xoa_trang();
            load_data_2_grid();
        ...
        private void load_data_2_cbo_danh_muc()
        {
            ...
            m_cbo_danh_muc.DataSource = v_ds.DM_DANH_MUC_THUOC;
...
//
		...
		//
		//
		private void f501_v_dm_nhom_thuoc_Load(object sender, System.EventArgs e) {
			try{
        ...
        private void m_grv_nhom_thuoc_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                update_v_dm_nhom_thuoc();
        ...
        private void m_cmd_search_Click(object sender, EventArgs e)
        {
            ...
            US_V_DM_NHOM_THUOC v_v_us_nhom_thuoc = new US_V_DM_NHOM_THUOC();
            DS_V_DM_NHOM_THUOC v_v_ds_nhom_thuoc = new DS_V_DM_NHOM_THUOC();
            v_v_us_nhom_thuoc.FillDataseSearch(v_v_ds_nhom_thuoc, v_str_tu_khoa);
            m_grv_nhom_thuoc.Redraw = false;
            CGridUtils.Dataset2C1Grid(v_v_ds_nhom_thuoc, m_grv_nhom_thuoc, m_obj_trans);
            m_grv_nhom_thuoc.Redraw = true;
        }
