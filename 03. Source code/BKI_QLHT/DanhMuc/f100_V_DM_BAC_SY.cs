...
namespace BKI_QLHT
{
	...
	public class f100_V_DM_BAC_SY : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(f100_V_DM_BAC_SY));
			...
			// m_fg
			// 
			this.m_fg.ColumnInfo = @"7,1,0,0,0,85,Columns:0{Width:13;}	 1{Caption:""Họ tên"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}5{Caption:""Mã bệnh viện"";Visible:False;DataType:System.Decimal;TextAlign:RightCenter;TextAlignFixed:CenterCenter;}3{Caption:""Địa chỉ"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}2{Caption:""Bệnh viện"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}6{Caption:""ID loại từ điển"";Visible:False;DataType:System.Decimal;TextAlign:RightCenter;TextAlignFixed:CenterCenter;}4{Caption:""Điện thoại"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}	";
...
,DIEN_THOAI = 4
		...
		DS_V_DM_BAC_SY m_ds = new DS_V_DM_BAC_SY();
		US_V_DM_BAC_SY m_us = new US_V_DM_BAC_SY();
		#endregion
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_ds.V_DM_BAC_SY.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){						
			m_ds = new DS_V_DM_BAC_SY();			
		...
		private void insert_v_dm_bac_sy(){			
		//	f100_V_DM_BAC_SY_DE v_fDE = new  f100_V_DM_BAC_SY_DE();								
		//	v_fDE.display();
			load_data_2_grid();
		}

		private void update_v_dm_bac_sy(){			
		...
		private void delete_v_dm_bac_sy(){
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			if (BaseMessages.askUser_DataCouldBeDeleted(8) != BaseMessages.IsDataCouldBeDeleted.CouldBeDeleted)  return;
			US_V_DM_BAC_SY v_us = new US_V_DM_BAC_SY();
