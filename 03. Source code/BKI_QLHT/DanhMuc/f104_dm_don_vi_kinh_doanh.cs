...
{
    public partial class f104_dm_don_vi_kinh_doanh : Form
    {
        public f104_dm_don_vi_kinh_doanh()
        {
            format_control();
        }
        ...
        private bool check_validate()
        {
            ...
            if (!CValidateTextBox.IsValid(m_txt_ghi_chu, DataType.StringType, allowNull.NO, true)) return false;
            return true;
        }
